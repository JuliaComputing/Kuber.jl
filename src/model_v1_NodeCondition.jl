...
function set_field!(o::V1NodeCondition, name::Symbol, val)
    setfield!(o, name, fieldtype(V1NodeCondition,name)(val))
end

convert(::Type{ V1NodeCondition }, json::Dict{String,Any}) = Swagger.from_json(V1NodeCondition, json)
