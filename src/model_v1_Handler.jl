...
function set_field!(o::V1Handler, name::Symbol, val)
    setfield!(o, name, fieldtype(V1Handler,name)(val))
end

convert(::Type{ V1Handler }, json::Dict{String,Any}) = Swagger.from_json(V1Handler, json)
