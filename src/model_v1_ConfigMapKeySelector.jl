...
function set_field!(o::V1ConfigMapKeySelector, name::Symbol, val)
    setfield!(o, name, fieldtype(V1ConfigMapKeySelector,name)(val))
end

convert(::Type{ V1ConfigMapKeySelector }, json::Dict{String,Any}) = Swagger.from_json(V1ConfigMapKeySelector, json)
