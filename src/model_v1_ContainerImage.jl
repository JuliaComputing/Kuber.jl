...
function set_field!(o::V1ContainerImage, name::Symbol, val)
    setfield!(o, name, fieldtype(V1ContainerImage,name)(val))
end

convert(::Type{ V1ContainerImage }, json::Dict{String,Any}) = Swagger.from_json(V1ContainerImage, json)
