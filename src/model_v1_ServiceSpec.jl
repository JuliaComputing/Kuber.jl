...
function set_field!(o::V1ServiceSpec, name::Symbol, val)
    setfield!(o, name, fieldtype(V1ServiceSpec,name)(val))
end

convert(::Type{ V1ServiceSpec }, json::Dict{String,Any}) = Swagger.from_json(V1ServiceSpec, json)
