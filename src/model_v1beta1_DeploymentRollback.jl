...
type V1beta1DeploymentRollback
...
function set_field!(o::V1beta1DeploymentRollback, name::Symbol, val)
    setfield!(o, name, fieldtype(V1beta1DeploymentRollback,name)(val))
end

convert(::Type{ V1beta1DeploymentRollback }, json::Dict{String,Any}) = Swagger.from_json(V1beta1DeploymentRollback, json)
