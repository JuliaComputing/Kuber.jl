...
function set_field!(o::V1alpha1PolicyRule, name::Symbol, val)
    setfield!(o, name, fieldtype(V1alpha1PolicyRule,name)(val))
end

convert(::Type{ V1alpha1PolicyRule }, json::Dict{String,Any}) = Swagger.from_json(V1alpha1PolicyRule, json)
