...
function set_field!(o::V1beta1NetworkPolicyPort, name::Symbol, val)
    setfield!(o, name, fieldtype(V1beta1NetworkPolicyPort,name)(val))
end

convert(::Type{ V1beta1NetworkPolicyPort }, json::Dict{String,Any}) = Swagger.from_json(V1beta1NetworkPolicyPort, json)
