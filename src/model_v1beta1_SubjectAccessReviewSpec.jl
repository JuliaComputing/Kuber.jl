...
function set_field!(o::V1beta1SubjectAccessReviewSpec, name::Symbol, val)
    setfield!(o, name, fieldtype(V1beta1SubjectAccessReviewSpec,name)(val))
end

convert(::Type{ V1beta1SubjectAccessReviewSpec }, json::Dict{String,Any}) = Swagger.from_json(V1beta1SubjectAccessReviewSpec, json)
