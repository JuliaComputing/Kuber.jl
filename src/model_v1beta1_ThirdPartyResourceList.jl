...
type V1beta1ThirdPartyResourceList
...
function set_field!(o::V1beta1ThirdPartyResourceList, name::Symbol, val)
    setfield!(o, name, fieldtype(V1beta1ThirdPartyResourceList,name)(val))
end

convert(::Type{ V1beta1ThirdPartyResourceList }, json::Dict{String,Any}) = Swagger.from_json(V1beta1ThirdPartyResourceList, json)
