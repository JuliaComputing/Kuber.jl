...
function set_field!(o::V1PersistentVolumeList, name::Symbol, val)
    setfield!(o, name, fieldtype(V1PersistentVolumeList,name)(val))
end

convert(::Type{ V1PersistentVolumeList }, json::Dict{String,Any}) = Swagger.from_json(V1PersistentVolumeList, json)
