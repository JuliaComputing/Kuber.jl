...
function set_field!(o::V1PodStatus, name::Symbol, val)
    setfield!(o, name, fieldtype(V1PodStatus,name)(val))
end

convert(::Type{ V1PodStatus }, json::Dict{String,Any}) = Swagger.from_json(V1PodStatus, json)
