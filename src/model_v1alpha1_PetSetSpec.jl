...
function set_field!(o::V1alpha1PetSetSpec, name::Symbol, val)
    setfield!(o, name, fieldtype(V1alpha1PetSetSpec,name)(val))
end

convert(::Type{ V1alpha1PetSetSpec }, json::Dict{String,Any}) = Swagger.from_json(V1alpha1PetSetSpec, json)
