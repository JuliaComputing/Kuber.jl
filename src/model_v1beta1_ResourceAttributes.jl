...
function set_field!(o::V1beta1ResourceAttributes, name::Symbol, val)
    setfield!(o, name, fieldtype(V1beta1ResourceAttributes,name)(val))
end

convert(::Type{ V1beta1ResourceAttributes }, json::Dict{String,Any}) = Swagger.from_json(V1beta1ResourceAttributes, json)
