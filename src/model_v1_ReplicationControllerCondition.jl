...
function set_field!(o::V1ReplicationControllerCondition, name::Symbol, val)
    setfield!(o, name, fieldtype(V1ReplicationControllerCondition,name)(val))
end

convert(::Type{ V1ReplicationControllerCondition }, json::Dict{String,Any}) = Swagger.from_json(V1ReplicationControllerCondition, json)
