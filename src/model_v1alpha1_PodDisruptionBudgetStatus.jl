...
type V1alpha1PodDisruptionBudgetStatus
...
function set_field!(o::V1alpha1PodDisruptionBudgetStatus, name::Symbol, val)
    setfield!(o, name, fieldtype(V1alpha1PodDisruptionBudgetStatus,name)(val))
end

convert(::Type{ V1alpha1PodDisruptionBudgetStatus }, json::Dict{String,Any}) = Swagger.from_json(V1alpha1PodDisruptionBudgetStatus, json)
