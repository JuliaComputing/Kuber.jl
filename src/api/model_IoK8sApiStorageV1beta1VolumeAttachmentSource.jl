...
mutable struct IoK8sApiStorageV1beta1VolumeAttachmentSource <: SwaggerModel
    ...
    function IoK8sApiStorageV1beta1VolumeAttachmentSource(;inlineVolumeSpec=nothing, persistentVolumeName=nothing)
        o = new()
        validate_property(IoK8sApiStorageV1beta1VolumeAttachmentSource, Symbol("inlineVolumeSpec"), inlineVolumeSpec)
...
const _property_map_IoK8sApiStorageV1beta1VolumeAttachmentSource = Dict{Symbol,Symbol}(Symbol("inlineVolumeSpec")=>Symbol("inlineVolumeSpec"), Symbol("persistentVolumeName")=>Symbol("persistentVolumeName"))
...
Swagger.property_type(::Type{ IoK8sApiStorageV1beta1VolumeAttachmentSource }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiStorageV1beta1VolumeAttachmentSource[name]))}
