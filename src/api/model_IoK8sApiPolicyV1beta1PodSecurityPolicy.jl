...
@doc raw"""PodSecurityPolicy governs the ability to make requests that affect the Security Context that will be applied to a pod and container.
    ...
    - spec::IoK8sApiPolicyV1beta1PodSecurityPolicySpec : spec defines the policy enforced.
"""
...
Swagger.property_type(::Type{ IoK8sApiPolicyV1beta1PodSecurityPolicy }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiPolicyV1beta1PodSecurityPolicy[name]))}
