...
Return: IoK8sApimachineryPkgApisMetaV1Status
"""
function deletePolicyV1beta1CollectionPodSecurityPolicy(_api::PolicyV1beta1Api; includeUninitialized=nothing, pretty=nothing, __continue__=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
"""
function listPolicyV1beta1NamespacedPodDisruptionBudget(_api::PolicyV1beta1Api, namespace::String; includeUninitialized=nothing, pretty=nothing, __continue__=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApiPolicyV1beta1PodDisruptionBudgetList
"""
function listPolicyV1beta1PodDisruptionBudgetForAllNamespaces(_api::PolicyV1beta1Api; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
"""
function listPolicyV1beta1PodSecurityPolicy(_api::PolicyV1beta1Api; includeUninitialized=nothing, pretty=nothing, __continue__=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchPolicyV1beta1NamespacedPodDisruptionBudgetList(_api::PolicyV1beta1Api, namespace::String; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchPolicyV1beta1PodDisruptionBudgetListForAllNamespaces(_api::PolicyV1beta1Api; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchPolicyV1beta1PodSecurityPolicy(_api::PolicyV1beta1Api, name::String; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchPolicyV1beta1PodSecurityPolicyList(_api::PolicyV1beta1Api; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
