...
type IoK8sKubernetesPkgApiV1NodeSystemInfo <: SwaggerModel
    ...
    function IoK8sKubernetesPkgApiV1NodeSystemInfo(;architecture=nothing, bootID=nothing, containerRuntimeVersion=nothing, kernelVersion=nothing, kubeProxyVersion=nothing, kubeletVersion=nothing, machineID=nothing, operatingSystem=nothing, osImage=nothing, systemUUID=nothing)
        o = new()
...
const _name_map_IoK8sKubernetesPkgApiV1NodeSystemInfo = Dict{String,Symbol}(["architecture"=>:architecture, "bootID"=>:bootID, "containerRuntimeVersion"=>:containerRuntimeVersion, "kernelVersion"=>:kernelVersion, "kubeProxyVersion"=>:kubeProxyVersion, "kubeletVersion"=>:kubeletVersion, "machineID"=>:machineID, "operatingSystem"=>:operatingSystem, "osImage"=>:osImage, "systemUUID"=>:systemUUID])
const _field_map_IoK8sKubernetesPkgApiV1NodeSystemInfo = Dict{Symbol,String}([:architecture=>"architecture", :bootID=>"bootID", :containerRuntimeVersion=>"containerRuntimeVersion", :kernelVersion=>"kernelVersion", :kubeProxyVersion=>"kubeProxyVersion", :kubeletVersion=>"kubeletVersion", :machineID=>"machineID", :operatingSystem=>"operatingSystem", :osImage=>"osImage", :systemUUID=>"systemUUID"])
