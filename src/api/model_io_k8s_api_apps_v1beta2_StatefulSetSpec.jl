...
mutable struct IoK8sApiAppsV1beta2StatefulSetSpec <: SwaggerModel
    ...
    updateStrategy::Union{ Nothing, IoK8sApiAppsV1beta2StatefulSetUpdateStrategy } # updateStrategy
...
const _name_map_IoK8sApiAppsV1beta2StatefulSetSpec = Dict{String,Symbol}(["podManagementPolicy"=>:podManagementPolicy, "replicas"=>:replicas, "revisionHistoryLimit"=>:revisionHistoryLimit, "selector"=>:selector, "serviceName"=>:serviceName, "template"=>:template, "updateStrategy"=>:updateStrategy, "volumeClaimTemplates"=>:volumeClaimTemplates])
const _field_map_IoK8sApiAppsV1beta2StatefulSetSpec = Dict{Symbol,String}([:podManagementPolicy=>"podManagementPolicy", :replicas=>"replicas", :revisionHistoryLimit=>"revisionHistoryLimit", :selector=>"selector", :serviceName=>"serviceName", :template=>"template", :updateStrategy=>"updateStrategy", :volumeClaimTemplates=>"volumeClaimTemplates"])
Swagger.name_map(::Type{ IoK8sApiAppsV1beta2StatefulSetSpec }) = _name_map_IoK8sApiAppsV1beta2StatefulSetSpec
Swagger.field_map(::Type{ IoK8sApiAppsV1beta2StatefulSetSpec }) = _field_map_IoK8sApiAppsV1beta2StatefulSetSpec
...
function validate_field(o::IoK8sApiAppsV1beta2StatefulSetSpec, name::Symbol, val)
end
