...
mutable struct IoK8sApiAppsV1beta2StatefulSetStatus <: SwaggerModel
    ...
    conditions::Any # spec type: Union{ Nothing, Vector{IoK8sApiAppsV1beta2StatefulSetCondition} } # spec name: conditions
    ...
    function IoK8sApiAppsV1beta2StatefulSetStatus(;collisionCount=nothing, conditions=nothing, currentReplicas=nothing, currentRevision=nothing, observedGeneration=nothing, readyReplicas=nothing, replicas=nothing, updateRevision=nothing, updatedReplicas=nothing)
        o = new()
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("collisionCount"), collisionCount)
        setfield!(o, Symbol("collisionCount"), collisionCount)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("conditions"), conditions)
        setfield!(o, Symbol("conditions"), conditions)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("currentReplicas"), currentReplicas)
        setfield!(o, Symbol("currentReplicas"), currentReplicas)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("currentRevision"), currentRevision)
        setfield!(o, Symbol("currentRevision"), currentRevision)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("observedGeneration"), observedGeneration)
        setfield!(o, Symbol("observedGeneration"), observedGeneration)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("readyReplicas"), readyReplicas)
        setfield!(o, Symbol("readyReplicas"), readyReplicas)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("replicas"), replicas)
        setfield!(o, Symbol("replicas"), replicas)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("updateRevision"), updateRevision)
        setfield!(o, Symbol("updateRevision"), updateRevision)
        validate_property(IoK8sApiAppsV1beta2StatefulSetStatus, Symbol("updatedReplicas"), updatedReplicas)
        setfield!(o, Symbol("updatedReplicas"), updatedReplicas)
        o
    end
end # type IoK8sApiAppsV1beta2StatefulSetStatus

const _property_map_IoK8sApiAppsV1beta2StatefulSetStatus = Dict{Symbol,Symbol}(Symbol("collisionCount")=>Symbol("collisionCount"), Symbol("conditions")=>Symbol("conditions"), Symbol("currentReplicas")=>Symbol("currentReplicas"), Symbol("currentRevision")=>Symbol("currentRevision"), Symbol("observedGeneration")=>Symbol("observedGeneration"), Symbol("readyReplicas")=>Symbol("readyReplicas"), Symbol("replicas")=>Symbol("replicas"), Symbol("updateRevision")=>Symbol("updateRevision"), Symbol("updatedReplicas")=>Symbol("updatedReplicas"))
...
Base.propertynames(::Type{ IoK8sApiAppsV1beta2StatefulSetStatus }) = collect(keys(_property_map_IoK8sApiAppsV1beta2StatefulSetStatus))
Swagger.property_type(::Type{ IoK8sApiAppsV1beta2StatefulSetStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1beta2StatefulSetStatus[name]))}
Swagger.field_name(::Type{ IoK8sApiAppsV1beta2StatefulSetStatus }, property_name::Symbol) =  _property_map_IoK8sApiAppsV1beta2StatefulSetStatus[property_name]
...
function validate_property(::Type{ IoK8sApiAppsV1beta2StatefulSetStatus }, name::Symbol, val)
end
