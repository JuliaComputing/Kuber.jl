...
Swagger.property_type(::Type{ IoK8sApiSettingsV1alpha1PodPreset }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiSettingsV1alpha1PodPreset[name]))}
