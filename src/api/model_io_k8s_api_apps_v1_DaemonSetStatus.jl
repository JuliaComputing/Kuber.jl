...
mutable struct IoK8sApiAppsV1DaemonSetStatus <: SwaggerModel
    ...
    conditions::Union{ Nothing, Vector{IoK8sApiAppsV1DaemonSetCondition} } # conditions
...
const _name_map_IoK8sApiAppsV1DaemonSetStatus = Dict{String,Symbol}(["collisionCount"=>:collisionCount, "conditions"=>:conditions, "currentNumberScheduled"=>:currentNumberScheduled, "desiredNumberScheduled"=>:desiredNumberScheduled, "numberAvailable"=>:numberAvailable, "numberMisscheduled"=>:numberMisscheduled, "numberReady"=>:numberReady, "numberUnavailable"=>:numberUnavailable, "observedGeneration"=>:observedGeneration, "updatedNumberScheduled"=>:updatedNumberScheduled])
const _field_map_IoK8sApiAppsV1DaemonSetStatus = Dict{Symbol,String}([:collisionCount=>"collisionCount", :conditions=>"conditions", :currentNumberScheduled=>"currentNumberScheduled", :desiredNumberScheduled=>"desiredNumberScheduled", :numberAvailable=>"numberAvailable", :numberMisscheduled=>"numberMisscheduled", :numberReady=>"numberReady", :numberUnavailable=>"numberUnavailable", :observedGeneration=>"observedGeneration", :updatedNumberScheduled=>"updatedNumberScheduled"])
Swagger.name_map(::Type{ IoK8sApiAppsV1DaemonSetStatus }) = _name_map_IoK8sApiAppsV1DaemonSetStatus
Swagger.field_map(::Type{ IoK8sApiAppsV1DaemonSetStatus }) = _field_map_IoK8sApiAppsV1DaemonSetStatus
...
function validate_field(o::IoK8sApiAppsV1DaemonSetStatus, name::Symbol, val)
end
