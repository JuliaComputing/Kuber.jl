...
immutable SchedulingV1alpha1Api <: SwaggerApi
...
Return: IoK8sApiSchedulingV1alpha1PriorityClass
"""
function readSchedulingV1alpha1PriorityClass(_api::SchedulingV1alpha1Api, name::String; pretty=nothing, exact=nothing, _export=nothing, _mediaType=nothing)
...
"""
function watchSchedulingV1alpha1PriorityClass(_api::SchedulingV1alpha1Api, name::String; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchSchedulingV1alpha1PriorityClassList(_api::SchedulingV1alpha1Api; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
