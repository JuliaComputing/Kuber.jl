...
Swagger.property_type(::Type{ IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec[name]))}
