...
type IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus <: SwaggerModel
    ...
    function IoK8sKubernetesPkgApisExtensionsV1beta1DeploymentStatus(;availableReplicas=nothing, collisionCount=nothing, conditions=nothing, observedGeneration=nothing, readyReplicas=nothing, replicas=nothing, unavailableReplicas=nothing, updatedReplicas=nothing)
        o = new()
