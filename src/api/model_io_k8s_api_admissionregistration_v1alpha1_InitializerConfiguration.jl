...
type IoK8sApiAdmissionregistrationV1alpha1InitializerConfiguration <: SwaggerModel
    apiVersion::Nullable{ String } # apiVersion
    initializers::Nullable{ Vector{IoK8sApiAdmissionregistrationV1alpha1Initializer} } # initializers
