...
const _property_types_IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceSubresources = Dict{Symbol,String}(Symbol("scale")=>"IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceSubresourceScale", Symbol("status")=>"String")
