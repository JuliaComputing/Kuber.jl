...
immutable AuthenticationV1beta1Api <: SwaggerApi
...
Param: body::IoK8sKubernetesPkgApisAuthenticationV1beta1TokenReview (required)
Param: pretty::String
Return: IoK8sKubernetesPkgApisAuthenticationV1beta1TokenReview
"""
function createAuthenticationV1beta1TokenReview(_api::AuthenticationV1beta1Api, body; pretty=nothing, _mediaType=nothing)
    _ctx = Swagger.Ctx(_api.client, "POST", IoK8sKubernetesPkgApisAuthenticationV1beta1TokenReview, "/apis/authentication.k8s.io/v1beta1/tokenreviews", ["BearerToken"], body)
