...
Swagger.property_type(::Type{ IoK8sApiAuthenticationV1UserInfo }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiAuthenticationV1UserInfo[name]))}
