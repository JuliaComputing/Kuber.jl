...
function createAuthenticationV1TokenReview(_api::AuthenticationV1Api, response_stream::Channel, body; dryRun=nothing, fieldManager=nothing, pretty=nothing, _mediaType=nothing)
    _ctx = _swaggerinternal_createAuthenticationV1TokenReview(_api, body; dryRun=dryRun, fieldManager=fieldManager, pretty=pretty, _mediaType=_mediaType)
...
function getAuthenticationV1APIResources(_api::AuthenticationV1Api, response_stream::Channel; _mediaType=nothing)
    _ctx = _swaggerinternal_getAuthenticationV1APIResources(_api; _mediaType=_mediaType)
    Swagger.exec(_ctx, response_stream)
end
