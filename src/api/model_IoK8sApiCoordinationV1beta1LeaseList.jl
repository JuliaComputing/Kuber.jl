...
Swagger.property_type(::Type{ IoK8sApiCoordinationV1beta1LeaseList }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiCoordinationV1beta1LeaseList[name]))}
