...
Return: IoK8sApiAdmissionregistrationV1alpha1InitializerConfiguration
"""
function readAdmissionregistrationV1alpha1InitializerConfiguration(_api::AdmissionregistrationV1alpha1Api, name::String; pretty=nothing, exact=nothing, __export__=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchAdmissionregistrationV1alpha1InitializerConfigurationList(_api::AdmissionregistrationV1alpha1Api; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
