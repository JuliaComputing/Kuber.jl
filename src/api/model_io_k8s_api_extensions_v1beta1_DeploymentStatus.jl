...
type IoK8sApiExtensionsV1beta1DeploymentStatus <: SwaggerModel
    availableReplicas::Nullable{ Int32 } # availableReplicas
    collisionCount::Nullable{ Int32 } # collisionCount
    conditions::Nullable{ Vector{IoK8sApiExtensionsV1beta1DeploymentCondition} } # conditions
...
const _name_map_IoK8sApiExtensionsV1beta1DeploymentStatus = Dict{String,Symbol}(["availableReplicas"=>:availableReplicas, "collisionCount"=>:collisionCount, "conditions"=>:conditions, "observedGeneration"=>:observedGeneration, "readyReplicas"=>:readyReplicas, "replicas"=>:replicas, "unavailableReplicas"=>:unavailableReplicas, "updatedReplicas"=>:updatedReplicas])
const _field_map_IoK8sApiExtensionsV1beta1DeploymentStatus = Dict{Symbol,String}([:availableReplicas=>"availableReplicas", :collisionCount=>"collisionCount", :conditions=>"conditions", :observedGeneration=>"observedGeneration", :readyReplicas=>"readyReplicas", :replicas=>"replicas", :unavailableReplicas=>"unavailableReplicas", :updatedReplicas=>"updatedReplicas"])
Swagger.name_map(::Type{ IoK8sApiExtensionsV1beta1DeploymentStatus }) = _name_map_IoK8sApiExtensionsV1beta1DeploymentStatus
Swagger.field_map(::Type{ IoK8sApiExtensionsV1beta1DeploymentStatus }) = _field_map_IoK8sApiExtensionsV1beta1DeploymentStatus

function check_required(o::IoK8sApiExtensionsV1beta1DeploymentStatus)
    true
end

function validate_field(o::IoK8sApiExtensionsV1beta1DeploymentStatus, name::Symbol, val)
end
