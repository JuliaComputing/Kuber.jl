...
"""
mutable struct IoK8sApiAdmissionregistrationV1RuleWithOperations <: SwaggerModel
    ...
    function IoK8sApiAdmissionregistrationV1RuleWithOperations(;apiGroups=nothing, apiVersions=nothing, operations=nothing, resources=nothing, scope=nothing)
        o = new()
        validate_property(IoK8sApiAdmissionregistrationV1RuleWithOperations, Symbol("apiGroups"), apiGroups)
        setfield!(o, Symbol("apiGroups"), apiGroups)
        validate_property(IoK8sApiAdmissionregistrationV1RuleWithOperations, Symbol("apiVersions"), apiVersions)
        setfield!(o, Symbol("apiVersions"), apiVersions)
        validate_property(IoK8sApiAdmissionregistrationV1RuleWithOperations, Symbol("operations"), operations)
        setfield!(o, Symbol("operations"), operations)
        validate_property(IoK8sApiAdmissionregistrationV1RuleWithOperations, Symbol("resources"), resources)
        setfield!(o, Symbol("resources"), resources)
        validate_property(IoK8sApiAdmissionregistrationV1RuleWithOperations, Symbol("scope"), scope)
        setfield!(o, Symbol("scope"), scope)
        o
    end
end # type IoK8sApiAdmissionregistrationV1RuleWithOperations

const _property_map_IoK8sApiAdmissionregistrationV1RuleWithOperations = Dict{Symbol,Symbol}(Symbol("apiGroups")=>Symbol("apiGroups"), Symbol("apiVersions")=>Symbol("apiVersions"), Symbol("operations")=>Symbol("operations"), Symbol("resources")=>Symbol("resources"), Symbol("scope")=>Symbol("scope"))
...
Base.propertynames(::Type{ IoK8sApiAdmissionregistrationV1RuleWithOperations }) = collect(keys(_property_map_IoK8sApiAdmissionregistrationV1RuleWithOperations))
Swagger.property_type(::Type{ IoK8sApiAdmissionregistrationV1RuleWithOperations }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAdmissionregistrationV1RuleWithOperations[name]))}
Swagger.field_name(::Type{ IoK8sApiAdmissionregistrationV1RuleWithOperations }, property_name::Symbol) =  _property_map_IoK8sApiAdmissionregistrationV1RuleWithOperations[property_name]

function check_required(o::IoK8sApiAdmissionregistrationV1RuleWithOperations)
    true
end

function validate_property(::Type{ IoK8sApiAdmissionregistrationV1RuleWithOperations }, name::Symbol, val)
end
