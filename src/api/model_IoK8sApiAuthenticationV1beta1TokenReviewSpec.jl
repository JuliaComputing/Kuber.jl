...
Swagger.property_type(::Type{ IoK8sApiAuthenticationV1beta1TokenReviewSpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAuthenticationV1beta1TokenReviewSpec[name]))}
