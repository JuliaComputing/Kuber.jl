...
const _property_map_IoK8sApiAuthenticationV1beta1TokenReviewSpec = Dict{Symbol,Symbol}(Symbol("token")=>Symbol("token"))
const _property_types_IoK8sApiAuthenticationV1beta1TokenReviewSpec = Dict{Symbol,String}(Symbol("token")=>"String")
