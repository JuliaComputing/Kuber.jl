...
Return: IoK8sApimachineryPkgApisMetaV1Status
"""
function deleteApiregistrationV1CollectionAPIService(_api::ApiregistrationV1Api; includeUninitialized=nothing, pretty=nothing, __continue__=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
"""
function listApiregistrationV1APIService(_api::ApiregistrationV1Api; includeUninitialized=nothing, pretty=nothing, __continue__=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
"""
function watchApiregistrationV1APIService(_api::ApiregistrationV1Api, name::String; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchApiregistrationV1APIServiceList(_api::ApiregistrationV1Api; __continue__=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
