...
"""
function createApiregistrationV1APIService(_api::ApiregistrationV1Api, body; includeUninitialized=nothing, pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
"""
function deleteApiregistrationV1APIService(_api::ApiregistrationV1Api, name::String, body; pretty=nothing, dryRun=nothing, gracePeriodSeconds=nothing, orphanDependents=nothing, propagationPolicy=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1Status
"""
function deleteApiregistrationV1CollectionAPIService(_api::ApiregistrationV1Api; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = Swagger.Ctx(_api.client, "DELETE", IoK8sApimachineryPkgApisMetaV1Status, "/apis/apiregistration.k8s.io/v1/apiservices", ["BearerToken"])
    Swagger.set_param(_ctx.query, "includeUninitialized", includeUninitialized)  # type Bool
    Swagger.set_param(_ctx.query, "pretty", pretty)  # type String
...
"""
function listApiregistrationV1APIService(_api::ApiregistrationV1Api; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1APIService
"""
function patchApiregistrationV1APIService(_api::ApiregistrationV1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1APIService
"""
function patchApiregistrationV1APIServiceStatus(_api::ApiregistrationV1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1APIService
"""
function readApiregistrationV1APIService(_api::ApiregistrationV1Api, name::String; pretty=nothing, exact=nothing, _export=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1APIService
"""
function replaceApiregistrationV1APIService(_api::ApiregistrationV1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1APIService
"""
function replaceApiregistrationV1APIServiceStatus(_api::ApiregistrationV1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
"""
function watchApiregistrationV1APIService(_api::ApiregistrationV1Api, name::String; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchApiregistrationV1APIServiceList(_api::ApiregistrationV1Api; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
