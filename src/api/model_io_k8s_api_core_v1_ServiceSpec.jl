...
type IoK8sApiCoreV1ServiceSpec <: SwaggerModel
    ...
    ports::Nullable{ Vector{IoK8sApiCoreV1ServicePort} } # ports
    publishNotReadyAddresses::Nullable{ Bool } # publishNotReadyAddresses
    selector::Nullable{ Dict{String, String} } # selector
    sessionAffinity::Nullable{ String } # sessionAffinity
    sessionAffinityConfig::Nullable{ IoK8sApiCoreV1SessionAffinityConfig } # sessionAffinityConfig
