...
type IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus <: SwaggerModel
...
function validate_field(o::IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus, name::Symbol, val)
end
