...
mutable struct IoK8sApiPolicyV1beta1PodSecurityPolicySpec <: SwaggerModel
    ...
    allowedFlexVolumes::Union{ Nothing, Vector{IoK8sApiPolicyV1beta1AllowedFlexVolume} } # allowedFlexVolumes
    allowedHostPaths::Union{ Nothing, Vector{IoK8sApiPolicyV1beta1AllowedHostPath} } # allowedHostPaths
    ...
    fsGroup::Union{ Nothing, IoK8sApiPolicyV1beta1FSGroupStrategyOptions } # fsGroup
    hostIPC::Union{ Nothing, Bool } # hostIPC
    hostNetwork::Union{ Nothing, Bool } # hostNetwork
    hostPID::Union{ Nothing, Bool } # hostPID
    hostPorts::Union{ Nothing, Vector{IoK8sApiPolicyV1beta1HostPortRange} } # hostPorts
    ...
    runAsUser::Union{ Nothing, IoK8sApiPolicyV1beta1RunAsUserStrategyOptions } # runAsUser
    seLinux::Union{ Nothing, IoK8sApiPolicyV1beta1SELinuxStrategyOptions } # seLinux
    supplementalGroups::Union{ Nothing, IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions } # supplementalGroups
...
const _name_map_IoK8sApiPolicyV1beta1PodSecurityPolicySpec = Dict{String,Symbol}(["allowPrivilegeEscalation"=>:allowPrivilegeEscalation, "allowedCapabilities"=>:allowedCapabilities, "allowedFlexVolumes"=>:allowedFlexVolumes, "allowedHostPaths"=>:allowedHostPaths, "allowedProcMountTypes"=>:allowedProcMountTypes, "allowedUnsafeSysctls"=>:allowedUnsafeSysctls, "defaultAddCapabilities"=>:defaultAddCapabilities, "defaultAllowPrivilegeEscalation"=>:defaultAllowPrivilegeEscalation, "forbiddenSysctls"=>:forbiddenSysctls, "fsGroup"=>:fsGroup, "hostIPC"=>:hostIPC, "hostNetwork"=>:hostNetwork, "hostPID"=>:hostPID, "hostPorts"=>:hostPorts, "privileged"=>:privileged, "readOnlyRootFilesystem"=>:readOnlyRootFilesystem, "requiredDropCapabilities"=>:requiredDropCapabilities, "runAsUser"=>:runAsUser, "seLinux"=>:seLinux, "supplementalGroups"=>:supplementalGroups, "volumes"=>:volumes])
const _field_map_IoK8sApiPolicyV1beta1PodSecurityPolicySpec = Dict{Symbol,String}([:allowPrivilegeEscalation=>"allowPrivilegeEscalation", :allowedCapabilities=>"allowedCapabilities", :allowedFlexVolumes=>"allowedFlexVolumes", :allowedHostPaths=>"allowedHostPaths", :allowedProcMountTypes=>"allowedProcMountTypes", :allowedUnsafeSysctls=>"allowedUnsafeSysctls", :defaultAddCapabilities=>"defaultAddCapabilities", :defaultAllowPrivilegeEscalation=>"defaultAllowPrivilegeEscalation", :forbiddenSysctls=>"forbiddenSysctls", :fsGroup=>"fsGroup", :hostIPC=>"hostIPC", :hostNetwork=>"hostNetwork", :hostPID=>"hostPID", :hostPorts=>"hostPorts", :privileged=>"privileged", :readOnlyRootFilesystem=>"readOnlyRootFilesystem", :requiredDropCapabilities=>"requiredDropCapabilities", :runAsUser=>"runAsUser", :seLinux=>"seLinux", :supplementalGroups=>"supplementalGroups", :volumes=>"volumes"])
Swagger.name_map(::Type{ IoK8sApiPolicyV1beta1PodSecurityPolicySpec }) = _name_map_IoK8sApiPolicyV1beta1PodSecurityPolicySpec
Swagger.field_map(::Type{ IoK8sApiPolicyV1beta1PodSecurityPolicySpec }) = _field_map_IoK8sApiPolicyV1beta1PodSecurityPolicySpec
...
function validate_field(o::IoK8sApiPolicyV1beta1PodSecurityPolicySpec, name::Symbol, val)
end
