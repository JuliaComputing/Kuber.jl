...
mutable struct IoK8sApiCoreV1NodeAffinity <: SwaggerModel
    preferredDuringSchedulingIgnoredDuringExecution::Union{ Nothing, Vector{IoK8sApiCoreV1PreferredSchedulingTerm} } # preferredDuringSchedulingIgnoredDuringExecution
    requiredDuringSchedulingIgnoredDuringExecution::Union{ Nothing, IoK8sApiCoreV1NodeSelector } # requiredDuringSchedulingIgnoredDuringExecution
