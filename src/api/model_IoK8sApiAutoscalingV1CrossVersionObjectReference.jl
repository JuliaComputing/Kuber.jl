...
Swagger.property_type(::Type{ IoK8sApiAutoscalingV1CrossVersionObjectReference }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiAutoscalingV1CrossVersionObjectReference[name]))}
