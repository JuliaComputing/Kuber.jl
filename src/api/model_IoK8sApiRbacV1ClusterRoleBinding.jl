...
Swagger.property_type(::Type{ IoK8sApiRbacV1ClusterRoleBinding }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiRbacV1ClusterRoleBinding[name]))}
