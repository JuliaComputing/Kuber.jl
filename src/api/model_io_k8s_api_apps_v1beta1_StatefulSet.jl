...
type IoK8sApiAppsV1beta1StatefulSet <: SwaggerModel
    ...
    spec::Nullable{ IoK8sApiAppsV1beta1StatefulSetSpec } # spec
    status::Nullable{ IoK8sApiAppsV1beta1StatefulSetStatus } # status
