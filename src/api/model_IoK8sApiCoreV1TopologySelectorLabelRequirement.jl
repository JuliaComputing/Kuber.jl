...
Swagger.property_type(::Type{ IoK8sApiCoreV1TopologySelectorLabelRequirement }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiCoreV1TopologySelectorLabelRequirement[name]))}
