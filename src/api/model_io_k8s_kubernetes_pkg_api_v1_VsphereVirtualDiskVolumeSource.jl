...
type IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource <: SwaggerModel
    ...
    function IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource(;fsType=nothing, storagePolicyID=nothing, storagePolicyName=nothing, volumePath=nothing)
        o = new()
...
const _name_map_IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource = Dict{String,Symbol}(["fsType"=>:fsType, "storagePolicyID"=>:storagePolicyID, "storagePolicyName"=>:storagePolicyName, "volumePath"=>:volumePath])
const _field_map_IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource = Dict{Symbol,String}([:fsType=>"fsType", :storagePolicyID=>"storagePolicyID", :storagePolicyName=>"storagePolicyName", :volumePath=>"volumePath"])
