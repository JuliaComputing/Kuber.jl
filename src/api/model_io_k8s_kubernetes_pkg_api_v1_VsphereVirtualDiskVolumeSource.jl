...
const _name_map_IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource = Dict{String,Symbol}([])
const _field_map_IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource = Dict{Symbol,String}([])
