...
Swagger.property_type(::Type{ IoK8sApiStorageV1beta1VolumeAttachmentStatus }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiStorageV1beta1VolumeAttachmentStatus[name]))}
