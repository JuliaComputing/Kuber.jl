...
@doc raw"""Binding ties one object to another; for example, a pod is bound to a node by a scheduler. Deprecated in 1.7, please use the bindings subresource of pods instead.
    ...
    - target::IoK8sApiCoreV1ObjectReference : The target object that you want to bind to the standard object.
"""
...
Swagger.property_type(::Type{ IoK8sApiCoreV1Binding }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiCoreV1Binding[name]))}
