...
Swagger.property_type(::Type{ IoK8sApiBatchV1beta1CronJobStatus }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiBatchV1beta1CronJobStatus[name]))}
