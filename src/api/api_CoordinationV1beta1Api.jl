...
"""
function createCoordinationV1beta1NamespacedLease(_api::CoordinationV1beta1Api, namespace::String, body; includeUninitialized=nothing, pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
"""
function deleteCoordinationV1beta1CollectionNamespacedLease(_api::CoordinationV1beta1Api, namespace::String; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = Swagger.Ctx(_api.client, "DELETE", IoK8sApimachineryPkgApisMetaV1Status, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases", ["BearerToken"])
    Swagger.set_param(_ctx.path, "namespace", namespace)  # type String
    Swagger.set_param(_ctx.query, "includeUninitialized", includeUninitialized)  # type Bool
    Swagger.set_param(_ctx.query, "pretty", pretty)  # type String
...
Return: IoK8sApimachineryPkgApisMetaV1Status
"""
function deleteCoordinationV1beta1NamespacedLease(_api::CoordinationV1beta1Api, name::String, namespace::String, body; pretty=nothing, dryRun=nothing, gracePeriodSeconds=nothing, orphanDependents=nothing, propagationPolicy=nothing, _mediaType=nothing)
...
"""
function listCoordinationV1beta1LeaseForAllNamespaces(_api::CoordinationV1beta1Api; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApiCoordinationV1beta1LeaseList
"""
function listCoordinationV1beta1NamespacedLease(_api::CoordinationV1beta1Api, namespace::String; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApiCoordinationV1beta1Lease
"""
function patchCoordinationV1beta1NamespacedLease(_api::CoordinationV1beta1Api, name::String, namespace::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
Return: IoK8sApiCoordinationV1beta1Lease
"""
function readCoordinationV1beta1NamespacedLease(_api::CoordinationV1beta1Api, name::String, namespace::String; pretty=nothing, exact=nothing, _export=nothing, _mediaType=nothing)
...
Return: IoK8sApiCoordinationV1beta1Lease
"""
function replaceCoordinationV1beta1NamespacedLease(_api::CoordinationV1beta1Api, name::String, namespace::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
"""
function watchCoordinationV1beta1LeaseListForAllNamespaces(_api::CoordinationV1beta1Api; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchCoordinationV1beta1NamespacedLeaseList(_api::CoordinationV1beta1Api, namespace::String; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
