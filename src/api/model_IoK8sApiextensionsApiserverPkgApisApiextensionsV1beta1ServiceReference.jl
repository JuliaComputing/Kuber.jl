...
mutable struct IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference <: SwaggerModel
    ...
    function IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference(;name=nothing, namespace=nothing, path=nothing)
        o = new()
...
const _property_map_IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference = Dict{Symbol,Symbol}(Symbol("name")=>Symbol("name"), Symbol("namespace")=>Symbol("namespace"), Symbol("path")=>Symbol("path"))
const _property_types_IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("namespace")=>"String", Symbol("path")=>"String")
...
Swagger.property_type(::Type{ IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference[name]))}
