...
const _name_map_IoK8sKubernetesPkgApisAppsV1beta1DeploymentCondition = Dict{String,Symbol}([])
const _field_map_IoK8sKubernetesPkgApisAppsV1beta1DeploymentCondition = Dict{Symbol,String}([])
