...
mutable struct IoK8sApiExtensionsV1beta1DeploymentStatus <: SwaggerModel
    ...
    conditions::Any # spec type: Union{ Nothing, Vector{IoK8sApiExtensionsV1beta1DeploymentCondition} } # spec name: conditions
    ...
    function IoK8sApiExtensionsV1beta1DeploymentStatus(;availableReplicas=nothing, collisionCount=nothing, conditions=nothing, observedGeneration=nothing, readyReplicas=nothing, replicas=nothing, unavailableReplicas=nothing, updatedReplicas=nothing)
        o = new()
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("availableReplicas"), availableReplicas)
        setfield!(o, Symbol("availableReplicas"), availableReplicas)
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("collisionCount"), collisionCount)
        setfield!(o, Symbol("collisionCount"), collisionCount)
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("conditions"), conditions)
        setfield!(o, Symbol("conditions"), conditions)
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("observedGeneration"), observedGeneration)
        setfield!(o, Symbol("observedGeneration"), observedGeneration)
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("readyReplicas"), readyReplicas)
        setfield!(o, Symbol("readyReplicas"), readyReplicas)
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("replicas"), replicas)
        setfield!(o, Symbol("replicas"), replicas)
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("unavailableReplicas"), unavailableReplicas)
        setfield!(o, Symbol("unavailableReplicas"), unavailableReplicas)
        validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("updatedReplicas"), updatedReplicas)
...
function validate_property(::Type{ IoK8sApiExtensionsV1beta1DeploymentStatus }, name::Symbol, val)
end
