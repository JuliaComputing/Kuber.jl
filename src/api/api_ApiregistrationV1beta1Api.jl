...
"""
function createApiregistrationV1beta1APIService(_api::ApiregistrationV1beta1Api, body; includeUninitialized=nothing, pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
"""
function deleteApiregistrationV1beta1APIService(_api::ApiregistrationV1beta1Api, name::String, body; pretty=nothing, dryRun=nothing, gracePeriodSeconds=nothing, orphanDependents=nothing, propagationPolicy=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1Status
"""
function deleteApiregistrationV1beta1CollectionAPIService(_api::ApiregistrationV1beta1Api; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
"""
function listApiregistrationV1beta1APIService(_api::ApiregistrationV1beta1Api; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService
"""
function patchApiregistrationV1beta1APIService(_api::ApiregistrationV1beta1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService
"""
function patchApiregistrationV1beta1APIServiceStatus(_api::ApiregistrationV1beta1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService
"""
function replaceApiregistrationV1beta1APIService(_api::ApiregistrationV1beta1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
...
Return: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService
"""
function replaceApiregistrationV1beta1APIServiceStatus(_api::ApiregistrationV1beta1Api, name::String, body; pretty=nothing, dryRun=nothing, _mediaType=nothing)
