...
Swagger.property_type(::Type{ IoK8sApiStorageV1alpha1VolumeAttachment }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiStorageV1alpha1VolumeAttachment[name]))}
