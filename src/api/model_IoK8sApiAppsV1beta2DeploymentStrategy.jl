...
Swagger.property_type(::Type{ IoK8sApiAppsV1beta2DeploymentStrategy }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiAppsV1beta2DeploymentStrategy[name]))}
