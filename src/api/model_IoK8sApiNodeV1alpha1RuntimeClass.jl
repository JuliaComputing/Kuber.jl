...
Swagger.property_type(::Type{ IoK8sApiNodeV1alpha1RuntimeClass }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiNodeV1alpha1RuntimeClass[name]))}
