...
@doc raw"""ResourceQuota sets aggregate quota restrictions enforced per namespace
    ...
    - spec::IoK8sApiCoreV1ResourceQuotaSpec : Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    - status::IoK8sApiCoreV1ResourceQuotaStatus : Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
"""
...
Swagger.property_type(::Type{ IoK8sApiCoreV1ResourceQuota }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiCoreV1ResourceQuota[name]))}
