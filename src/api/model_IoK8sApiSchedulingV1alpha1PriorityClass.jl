...
const _property_map_IoK8sApiSchedulingV1alpha1PriorityClass = Dict{Symbol,Symbol}(Symbol("apiVersion")=>Symbol("apiVersion"), Symbol("description")=>Symbol("description"), Symbol("globalDefault")=>Symbol("globalDefault"), Symbol("kind")=>Symbol("kind"), Symbol("metadata")=>Symbol("metadata"), Symbol("value")=>Symbol("value"))
const _property_types_IoK8sApiSchedulingV1alpha1PriorityClass = Dict{Symbol,String}(Symbol("apiVersion")=>"String", Symbol("description")=>"String", Symbol("globalDefault")=>"Bool", Symbol("kind")=>"String", Symbol("metadata")=>"IoK8sApimachineryPkgApisMetaV1ObjectMeta", Symbol("value")=>"Int32")
...
Swagger.property_type(::Type{ IoK8sApiSchedulingV1alpha1PriorityClass }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiSchedulingV1alpha1PriorityClass[name]))}
