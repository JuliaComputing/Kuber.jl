...
Swagger.property_type(::Type{ IoK8sApiCertificatesV1beta1CertificateSigningRequestStatus }, name::Symbol) = Union{Nothing,eval(Meta.parse(_property_types_IoK8sApiCertificatesV1beta1CertificateSigningRequestStatus[name]))}
