...
mutable struct IoK8sApiAppsV1DaemonSetSpec <: SwaggerModel
    ...
    updateStrategy::Union{ Nothing, IoK8sApiAppsV1DaemonSetUpdateStrategy } # updateStrategy
...
const _name_map_IoK8sApiAppsV1DaemonSetSpec = Dict{String,Symbol}(["minReadySeconds"=>:minReadySeconds, "revisionHistoryLimit"=>:revisionHistoryLimit, "selector"=>:selector, "template"=>:template, "updateStrategy"=>:updateStrategy])
const _field_map_IoK8sApiAppsV1DaemonSetSpec = Dict{Symbol,String}([:minReadySeconds=>"minReadySeconds", :revisionHistoryLimit=>"revisionHistoryLimit", :selector=>"selector", :template=>"template", :updateStrategy=>"updateStrategy"])
Swagger.name_map(::Type{ IoK8sApiAppsV1DaemonSetSpec }) = _name_map_IoK8sApiAppsV1DaemonSetSpec
Swagger.field_map(::Type{ IoK8sApiAppsV1DaemonSetSpec }) = _field_map_IoK8sApiAppsV1DaemonSetSpec
...
function validate_field(o::IoK8sApiAppsV1DaemonSetSpec, name::Symbol, val)
end
