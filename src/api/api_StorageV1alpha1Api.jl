...
"""
function deleteStorageV1alpha1CollectionVolumeAttachment(_api::StorageV1alpha1Api; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
"""
function listStorageV1alpha1VolumeAttachment(_api::StorageV1alpha1Api; includeUninitialized=nothing, pretty=nothing, _continue=nothing, fieldSelector=nothing, labelSelector=nothing, limit=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApiStorageV1alpha1VolumeAttachment
"""
function readStorageV1alpha1VolumeAttachment(_api::StorageV1alpha1Api, name::String; pretty=nothing, exact=nothing, _export=nothing, _mediaType=nothing)
...
"""
function watchStorageV1alpha1VolumeAttachment(_api::StorageV1alpha1Api, name::String; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent
"""
function watchStorageV1alpha1VolumeAttachmentList(_api::StorageV1alpha1Api; _continue=nothing, fieldSelector=nothing, includeUninitialized=nothing, labelSelector=nothing, limit=nothing, pretty=nothing, resourceVersion=nothing, timeoutSeconds=nothing, watch=nothing, _mediaType=nothing)
