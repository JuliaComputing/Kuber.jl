...
function set_field!(o::V1HorizontalPodAutoscalerStatus, name::Symbol, val)
    setfield!(o, name, fieldtype(V1HorizontalPodAutoscalerStatus,name)(val))
end

convert(::Type{ V1HorizontalPodAutoscalerStatus }, json::Dict{String,Any}) = Swagger.from_json(V1HorizontalPodAutoscalerStatus, json)
