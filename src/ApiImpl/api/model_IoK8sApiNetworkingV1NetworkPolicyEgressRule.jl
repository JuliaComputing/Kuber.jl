...
Swagger.property_type(::Type{ IoK8sApiNetworkingV1NetworkPolicyEgressRule }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiNetworkingV1NetworkPolicyEgressRule[name]))}
