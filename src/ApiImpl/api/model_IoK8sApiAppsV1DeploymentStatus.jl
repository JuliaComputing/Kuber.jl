...
mutable struct IoK8sApiAppsV1DeploymentStatus <: SwaggerModel
    ...
    conditions::Any # spec type: Union{ Nothing, Vector{IoK8sApiAppsV1DeploymentCondition} } # spec name: conditions
...
Base.propertynames(::Type{ IoK8sApiAppsV1DeploymentStatus }) = collect(keys(_property_map_IoK8sApiAppsV1DeploymentStatus))
Swagger.property_type(::Type{ IoK8sApiAppsV1DeploymentStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1DeploymentStatus[name]))}
Swagger.field_name(::Type{ IoK8sApiAppsV1DeploymentStatus }, property_name::Symbol) =  _property_map_IoK8sApiAppsV1DeploymentStatus[property_name]

function check_required(o::IoK8sApiAppsV1DeploymentStatus)
    true
end

function validate_property(::Type{ IoK8sApiAppsV1DeploymentStatus }, name::Symbol, val)
end
