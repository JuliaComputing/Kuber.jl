...
@doc raw"""represents the current status of a scale subresource.
...
Swagger.property_type(::Type{ IoK8sApiExtensionsV1beta1ScaleStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1ScaleStatus[name]))}
