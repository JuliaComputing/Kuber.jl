...
@doc raw"""WebhookClientConfig contains the information to make a TLS connection with the webhook
    ...
    - service::IoK8sApiAdmissionregistrationV1beta1ServiceReference : &#x60;service&#x60; is a reference to the service for this webhook. Either &#x60;service&#x60; or &#x60;url&#x60; must be specified.  If the webhook is running within the cluster, then you should use &#x60;service&#x60;.
