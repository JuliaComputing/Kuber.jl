...
@doc raw"""ScaleIOVolumeSource represents a persistent ScaleIO volume
    ...
    - secretRef::IoK8sApiCoreV1LocalObjectReference : SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.
