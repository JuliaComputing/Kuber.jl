...
"""
mutable struct IoK8sApiAppsV1ReplicaSetSpec <: SwaggerModel
    ...
    function IoK8sApiAppsV1ReplicaSetSpec(;minReadySeconds=nothing, replicas=nothing, selector=nothing, template=nothing)
        o = new()
        validate_property(IoK8sApiAppsV1ReplicaSetSpec, Symbol("minReadySeconds"), minReadySeconds)
        setfield!(o, Symbol("minReadySeconds"), minReadySeconds)
        validate_property(IoK8sApiAppsV1ReplicaSetSpec, Symbol("replicas"), replicas)
        setfield!(o, Symbol("replicas"), replicas)
        validate_property(IoK8sApiAppsV1ReplicaSetSpec, Symbol("selector"), selector)
        setfield!(o, Symbol("selector"), selector)
        validate_property(IoK8sApiAppsV1ReplicaSetSpec, Symbol("template"), template)
        setfield!(o, Symbol("template"), template)
        o
    end
end # type IoK8sApiAppsV1ReplicaSetSpec

const _property_map_IoK8sApiAppsV1ReplicaSetSpec = Dict{Symbol,Symbol}(Symbol("minReadySeconds")=>Symbol("minReadySeconds"), Symbol("replicas")=>Symbol("replicas"), Symbol("selector")=>Symbol("selector"), Symbol("template")=>Symbol("template"))
const _property_types_IoK8sApiAppsV1ReplicaSetSpec = Dict{Symbol,String}(Symbol("minReadySeconds")=>"Int32", Symbol("replicas")=>"Int32", Symbol("selector")=>"IoK8sApimachineryPkgApisMetaV1LabelSelector", Symbol("template")=>"IoK8sApiCoreV1PodTemplateSpec")
Base.propertynames(::Type{ IoK8sApiAppsV1ReplicaSetSpec }) = collect(keys(_property_map_IoK8sApiAppsV1ReplicaSetSpec))
Swagger.property_type(::Type{ IoK8sApiAppsV1ReplicaSetSpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1ReplicaSetSpec[name]))}
Swagger.field_name(::Type{ IoK8sApiAppsV1ReplicaSetSpec }, property_name::Symbol) =  _property_map_IoK8sApiAppsV1ReplicaSetSpec[property_name]

function check_required(o::IoK8sApiAppsV1ReplicaSetSpec)
    (getproperty(o, Symbol("selector")) === nothing) && (return false)
    true
end

function validate_property(::Type{ IoK8sApiAppsV1ReplicaSetSpec }, name::Symbol, val)
end
