...
Swagger.property_type(::Type{ IoK8sApiExtensionsV1beta1IngressTLS }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1IngressTLS[name]))}
