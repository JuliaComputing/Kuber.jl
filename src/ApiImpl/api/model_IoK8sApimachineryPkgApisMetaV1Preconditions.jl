...
Swagger.property_type(::Type{ IoK8sApimachineryPkgApisMetaV1Preconditions }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApimachineryPkgApisMetaV1Preconditions[name]))}
