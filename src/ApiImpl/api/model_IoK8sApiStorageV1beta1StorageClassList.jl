...
Swagger.property_type(::Type{ IoK8sApiStorageV1beta1StorageClassList }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiStorageV1beta1StorageClassList[name]))}
