...
struct ApiextensionsV1Api <: SwaggerApi
...
function deleteApiextensionsV1CustomResourceDefinition(_api::ApiextensionsV1Api, response_stream::Channel, name::String; pretty=nothing, body=nothing, dryRun=nothing, gracePeriodSeconds=nothing, orphanDependents=nothing, propagationPolicy=nothing, _mediaType=nothing)
    _ctx = _swaggerinternal_deleteApiextensionsV1CustomResourceDefinition(_api, name; pretty=pretty, body=body, dryRun=dryRun, gracePeriodSeconds=gracePeriodSeconds, orphanDependents=orphanDependents, propagationPolicy=propagationPolicy, _mediaType=_mediaType)
    Swagger.exec(_ctx, response_stream)
end
...
function getApiextensionsV1APIResources(_api::ApiextensionsV1Api, response_stream::Channel; _mediaType=nothing)
    _ctx = _swaggerinternal_getApiextensionsV1APIResources(_api; _mediaType=_mediaType)
    Swagger.exec(_ctx, response_stream)
end
...
function patchApiextensionsV1CustomResourceDefinitionStatus(_api::ApiextensionsV1Api, response_stream::Channel, name::String, body; pretty=nothing, dryRun=nothing, fieldManager=nothing, force=nothing, _mediaType=nothing)
    _ctx = _swaggerinternal_patchApiextensionsV1CustomResourceDefinitionStatus(_api, name, body; pretty=pretty, dryRun=dryRun, fieldManager=fieldManager, force=force, _mediaType=_mediaType)
    Swagger.exec(_ctx, response_stream)
end
...
function readApiextensionsV1CustomResourceDefinition(_api::ApiextensionsV1Api, response_stream::Channel, name::String; pretty=nothing, exact=nothing, __export__=nothing, _mediaType=nothing)
    _ctx = _swaggerinternal_readApiextensionsV1CustomResourceDefinition(_api, name; pretty=pretty, exact=exact, __export__=__export__, _mediaType=_mediaType)
    Swagger.exec(_ctx, response_stream)
end
...
function replaceApiextensionsV1CustomResourceDefinitionStatus(_api::ApiextensionsV1Api, response_stream::Channel, name::String, body; pretty=nothing, dryRun=nothing, fieldManager=nothing, _mediaType=nothing)
    _ctx = _swaggerinternal_replaceApiextensionsV1CustomResourceDefinitionStatus(_api, name, body; pretty=pretty, dryRun=dryRun, fieldManager=fieldManager, _mediaType=_mediaType)
    Swagger.exec(_ctx, response_stream)
end
