...
@doc raw"""DEPRECATED - This group version of Deployment is deprecated by apps/v1beta2/Deployment. See the release notes for more information. Deployment enables declarative updates for Pods and ReplicaSets.
    ...
    - spec::IoK8sApiExtensionsV1beta1DeploymentSpec : Specification of the desired behavior of the Deployment.
    - status::IoK8sApiExtensionsV1beta1DeploymentStatus : Most recently observed status of the Deployment.
"""
...
Swagger.property_type(::Type{ IoK8sApiExtensionsV1beta1Deployment }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1Deployment[name]))}
