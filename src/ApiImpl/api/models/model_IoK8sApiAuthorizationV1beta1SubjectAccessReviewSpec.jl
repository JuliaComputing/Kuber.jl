...
@doc raw"""io.k8s.api.authorization.v1beta1.SubjectAccessReviewSpec
...
"""
Base.@kwdef mutable struct IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec <: OpenAPI.APIModel
    ...
    function IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec(extra, group, nonResourceAttributes, resourceAttributes, uid, user, )
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec, Symbol("extra"), extra)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec, Symbol("group"), group)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec, Symbol("nonResourceAttributes"), nonResourceAttributes)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec, Symbol("resourceAttributes"), resourceAttributes)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec, Symbol("uid"), uid)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec, Symbol("user"), user)
        return new(extra, group, nonResourceAttributes, resourceAttributes, uid, user, )
    end
...
OpenAPI.property_type(::Type{ IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec[name]))}

function check_required(o::IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec }, name::Symbol, val)
end
