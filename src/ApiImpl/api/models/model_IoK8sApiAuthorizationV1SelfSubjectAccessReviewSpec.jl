...
@doc raw"""io.k8s.api.authorization.v1.SelfSubjectAccessReviewSpec
...
"""
Base.@kwdef mutable struct IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec <: OpenAPI.APIModel
    ...
    function IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec(nonResourceAttributes, resourceAttributes, )
        OpenAPI.validate_property(IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec, Symbol("nonResourceAttributes"), nonResourceAttributes)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec, Symbol("resourceAttributes"), resourceAttributes)
...
OpenAPI.property_type(::Type{ IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec[name]))}

function check_required(o::IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec }, name::Symbol, val)
end
