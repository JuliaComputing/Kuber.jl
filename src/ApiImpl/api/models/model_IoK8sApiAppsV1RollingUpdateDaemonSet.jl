...
@doc raw"""io.k8s.api.apps.v1.RollingUpdateDaemonSet
...
function OpenAPI.validate_property(::Type{ IoK8sApiAppsV1RollingUpdateDaemonSet }, name::Symbol, val)
    if name === Symbol("maxUnavailable")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1RollingUpdateDaemonSet", :format, val, "int-or-string")
    end
end
