...
@doc raw"""io.k8s.api.apps.v1beta2.DeploymentStatus
...
"""
Base.@kwdef mutable struct IoK8sApiAppsV1beta2DeploymentStatus <: OpenAPI.APIModel
    availableReplicas::Union{Nothing, Int64} = nothing
    collisionCount::Union{Nothing, Int64} = nothing
    conditions::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{IoK8sApiAppsV1beta2DeploymentCondition} }
    ...
    function IoK8sApiAppsV1beta2DeploymentStatus(availableReplicas, collisionCount, conditions, observedGeneration, readyReplicas, replicas, unavailableReplicas, updatedReplicas, )
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("availableReplicas"), availableReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("collisionCount"), collisionCount)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("conditions"), conditions)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("observedGeneration"), observedGeneration)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("readyReplicas"), readyReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("replicas"), replicas)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("unavailableReplicas"), unavailableReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2DeploymentStatus, Symbol("updatedReplicas"), updatedReplicas)
...
OpenAPI.property_type(::Type{ IoK8sApiAppsV1beta2DeploymentStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1beta2DeploymentStatus[name]))}

function check_required(o::IoK8sApiAppsV1beta2DeploymentStatus)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiAppsV1beta2DeploymentStatus }, name::Symbol, val)
    if name === Symbol("availableReplicas")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1beta2DeploymentStatus", :format, val, "int32")
    end
    if name === Symbol("collisionCount")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1beta2DeploymentStatus", :format, val, "int32")
    end
    if name === Symbol("observedGeneration")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1beta2DeploymentStatus", :format, val, "int64")
    end
