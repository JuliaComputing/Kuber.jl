...
@doc raw"""io.k8s.api.authorization.v1beta1.ResourceAttributes
...
"""
Base.@kwdef mutable struct IoK8sApiAuthorizationV1beta1ResourceAttributes <: OpenAPI.APIModel
    ...
    function IoK8sApiAuthorizationV1beta1ResourceAttributes(group, name, namespace, resource, subresource, verb, version, )
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1ResourceAttributes, Symbol("group"), group)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1ResourceAttributes, Symbol("name"), name)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1ResourceAttributes, Symbol("namespace"), namespace)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1ResourceAttributes, Symbol("resource"), resource)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1ResourceAttributes, Symbol("subresource"), subresource)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1ResourceAttributes, Symbol("verb"), verb)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1ResourceAttributes, Symbol("version"), version)
...
OpenAPI.property_type(::Type{ IoK8sApiAuthorizationV1beta1ResourceAttributes }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAuthorizationV1beta1ResourceAttributes[name]))}

function check_required(o::IoK8sApiAuthorizationV1beta1ResourceAttributes)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiAuthorizationV1beta1ResourceAttributes }, name::Symbol, val)
end
