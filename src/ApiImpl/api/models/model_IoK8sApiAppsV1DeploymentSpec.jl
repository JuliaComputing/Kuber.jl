...
@doc raw"""io.k8s.api.apps.v1.DeploymentSpec
...
"""
Base.@kwdef mutable struct IoK8sApiAppsV1DeploymentSpec <: OpenAPI.APIModel
    ...
    strategy = nothing # spec type: Union{ Nothing, IoK8sApiAppsV1DeploymentStrategy }
    template = nothing # spec type: Union{ Nothing, IoK8sApiCoreV1PodTemplateSpec }

    function IoK8sApiAppsV1DeploymentSpec(minReadySeconds, paused, progressDeadlineSeconds, replicas, revisionHistoryLimit, selector, strategy, template, )
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("minReadySeconds"), minReadySeconds)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("paused"), paused)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("progressDeadlineSeconds"), progressDeadlineSeconds)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("replicas"), replicas)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("revisionHistoryLimit"), revisionHistoryLimit)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("selector"), selector)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("strategy"), strategy)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentSpec, Symbol("template"), template)
...
OpenAPI.property_type(::Type{ IoK8sApiAppsV1DeploymentSpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1DeploymentSpec[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiAppsV1DeploymentSpec }, name::Symbol, val)
    if name === Symbol("minReadySeconds")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1DeploymentSpec", :format, val, "int32")
    end
