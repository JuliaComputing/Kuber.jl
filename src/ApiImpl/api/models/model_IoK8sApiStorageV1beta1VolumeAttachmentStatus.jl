...
@doc raw"""io.k8s.api.storage.v1beta1.VolumeAttachmentStatus
...
"""
Base.@kwdef mutable struct IoK8sApiStorageV1beta1VolumeAttachmentStatus <: OpenAPI.APIModel
    attachError = nothing # spec type: Union{ Nothing, IoK8sApiStorageV1beta1VolumeError }
    ...
    function IoK8sApiStorageV1beta1VolumeAttachmentStatus(attachError, attached, attachmentMetadata, detachError, )
        OpenAPI.validate_property(IoK8sApiStorageV1beta1VolumeAttachmentStatus, Symbol("attachError"), attachError)
        OpenAPI.validate_property(IoK8sApiStorageV1beta1VolumeAttachmentStatus, Symbol("attached"), attached)
        OpenAPI.validate_property(IoK8sApiStorageV1beta1VolumeAttachmentStatus, Symbol("attachmentMetadata"), attachmentMetadata)
        OpenAPI.validate_property(IoK8sApiStorageV1beta1VolumeAttachmentStatus, Symbol("detachError"), detachError)
...
OpenAPI.property_type(::Type{ IoK8sApiStorageV1beta1VolumeAttachmentStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiStorageV1beta1VolumeAttachmentStatus[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiStorageV1beta1VolumeAttachmentStatus }, name::Symbol, val)
end
