...
@doc raw"""io.k8s.api.extensions.v1beta1.IPBlock
...
"""
Base.@kwdef mutable struct IoK8sApiExtensionsV1beta1IPBlock <: OpenAPI.APIModel
    cidr::Union{Nothing, String} = nothing
    except::Union{Nothing, Vector{String}} = nothing

    function IoK8sApiExtensionsV1beta1IPBlock(cidr, except, )
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1IPBlock, Symbol("cidr"), cidr)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1IPBlock, Symbol("except"), except)
...
OpenAPI.property_type(::Type{ IoK8sApiExtensionsV1beta1IPBlock }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1IPBlock[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiExtensionsV1beta1IPBlock }, name::Symbol, val)
end
