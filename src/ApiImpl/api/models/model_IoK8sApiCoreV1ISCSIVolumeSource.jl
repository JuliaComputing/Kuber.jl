...
@doc raw"""io.k8s.api.core.v1.ISCSIVolumeSource
...
"""
Base.@kwdef mutable struct IoK8sApiCoreV1ISCSIVolumeSource <: OpenAPI.APIModel
    ...
    function IoK8sApiCoreV1ISCSIVolumeSource(chapAuthDiscovery, chapAuthSession, fsType, initiatorName, iqn, iscsiInterface, lun, portals, readOnly, secretRef, targetPortal, )
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("chapAuthDiscovery"), chapAuthDiscovery)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("chapAuthSession"), chapAuthSession)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("fsType"), fsType)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("initiatorName"), initiatorName)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("iqn"), iqn)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("iscsiInterface"), iscsiInterface)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("lun"), lun)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("portals"), portals)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("readOnly"), readOnly)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("secretRef"), secretRef)
        OpenAPI.validate_property(IoK8sApiCoreV1ISCSIVolumeSource, Symbol("targetPortal"), targetPortal)
...
OpenAPI.property_type(::Type{ IoK8sApiCoreV1ISCSIVolumeSource }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiCoreV1ISCSIVolumeSource[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiCoreV1ISCSIVolumeSource }, name::Symbol, val)
    if name === Symbol("lun")
        OpenAPI.validate_param(name, "IoK8sApiCoreV1ISCSIVolumeSource", :format, val, "int32")
    end
end
