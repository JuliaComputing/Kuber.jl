...
@doc raw"""io.k8s.api.rbac.v1.Subject
...
"""
Base.@kwdef mutable struct IoK8sApiRbacV1Subject <: OpenAPI.APIModel
    apiGroup::Union{Nothing, String} = nothing
    kind::Union{Nothing, String} = nothing
    name::Union{Nothing, String} = nothing
    namespace::Union{Nothing, String} = nothing

    function IoK8sApiRbacV1Subject(apiGroup, kind, name, namespace, )
        OpenAPI.validate_property(IoK8sApiRbacV1Subject, Symbol("apiGroup"), apiGroup)
        OpenAPI.validate_property(IoK8sApiRbacV1Subject, Symbol("kind"), kind)
        OpenAPI.validate_property(IoK8sApiRbacV1Subject, Symbol("name"), name)
        OpenAPI.validate_property(IoK8sApiRbacV1Subject, Symbol("namespace"), namespace)
...
OpenAPI.property_type(::Type{ IoK8sApiRbacV1Subject }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiRbacV1Subject[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiRbacV1Subject }, name::Symbol, val)
end
