...
@doc raw"""io.k8s.api.networking.v1beta1.IngressBackend
...
Base.@kwdef mutable struct IoK8sApiNetworkingV1beta1IngressBackend <: OpenAPI.APIModel
    ...
    function IoK8sApiNetworkingV1beta1IngressBackend(serviceName, servicePort, )
        ...
        OpenAPI.validate_property(IoK8sApiNetworkingV1beta1IngressBackend, Symbol("servicePort"), servicePort)
...
function OpenAPI.validate_property(::Type{ IoK8sApiNetworkingV1beta1IngressBackend }, name::Symbol, val)
    if name === Symbol("servicePort")
        OpenAPI.validate_param(name, "IoK8sApiNetworkingV1beta1IngressBackend", :format, val, "int-or-string")
    end
end
