...
@doc raw"""io.k8s.api.policy.v1beta1.SupplementalGroupsStrategyOptions
...
"""
Base.@kwdef mutable struct IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions <: OpenAPI.APIModel
    ...
    function IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions(ranges, rule, )
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions, Symbol("ranges"), ranges)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions, Symbol("rule"), rule)
...
OpenAPI.property_type(::Type{ IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions[name]))}

function check_required(o::IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions }, name::Symbol, val)
end
