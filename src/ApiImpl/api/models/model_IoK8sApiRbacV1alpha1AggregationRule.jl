...
@doc raw"""io.k8s.api.rbac.v1alpha1.AggregationRule
...
"""
Base.@kwdef mutable struct IoK8sApiRbacV1alpha1AggregationRule <: OpenAPI.APIModel
    ...
    function IoK8sApiRbacV1alpha1AggregationRule(clusterRoleSelectors, )
        OpenAPI.validate_property(IoK8sApiRbacV1alpha1AggregationRule, Symbol("clusterRoleSelectors"), clusterRoleSelectors)
...
OpenAPI.property_type(::Type{ IoK8sApiRbacV1alpha1AggregationRule }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiRbacV1alpha1AggregationRule[name]))}

function check_required(o::IoK8sApiRbacV1alpha1AggregationRule)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiRbacV1alpha1AggregationRule }, name::Symbol, val)
end
