...
@doc raw"""io.k8s.api.authentication.v1.UserInfo
...
"""
Base.@kwdef mutable struct IoK8sApiAuthenticationV1UserInfo <: OpenAPI.APIModel
    ...
    function IoK8sApiAuthenticationV1UserInfo(extra, groups, uid, username, )
        OpenAPI.validate_property(IoK8sApiAuthenticationV1UserInfo, Symbol("extra"), extra)
        OpenAPI.validate_property(IoK8sApiAuthenticationV1UserInfo, Symbol("groups"), groups)
        OpenAPI.validate_property(IoK8sApiAuthenticationV1UserInfo, Symbol("uid"), uid)
        OpenAPI.validate_property(IoK8sApiAuthenticationV1UserInfo, Symbol("username"), username)
...
OpenAPI.property_type(::Type{ IoK8sApiAuthenticationV1UserInfo }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAuthenticationV1UserInfo[name]))}

function check_required(o::IoK8sApiAuthenticationV1UserInfo)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiAuthenticationV1UserInfo }, name::Symbol, val)
end
