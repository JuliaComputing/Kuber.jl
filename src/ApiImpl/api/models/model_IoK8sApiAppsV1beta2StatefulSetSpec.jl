...
@doc raw"""io.k8s.api.apps.v1beta2.StatefulSetSpec
...
"""
Base.@kwdef mutable struct IoK8sApiAppsV1beta2StatefulSetSpec <: OpenAPI.APIModel
    ...
    function IoK8sApiAppsV1beta2StatefulSetSpec(podManagementPolicy, replicas, revisionHistoryLimit, selector, serviceName, template, updateStrategy, volumeClaimTemplates, )
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("podManagementPolicy"), podManagementPolicy)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("replicas"), replicas)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("revisionHistoryLimit"), revisionHistoryLimit)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("selector"), selector)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("serviceName"), serviceName)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("template"), template)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("updateStrategy"), updateStrategy)
        OpenAPI.validate_property(IoK8sApiAppsV1beta2StatefulSetSpec, Symbol("volumeClaimTemplates"), volumeClaimTemplates)
...
OpenAPI.property_type(::Type{ IoK8sApiAppsV1beta2StatefulSetSpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1beta2StatefulSetSpec[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiAppsV1beta2StatefulSetSpec }, name::Symbol, val)
    if name === Symbol("replicas")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1beta2StatefulSetSpec", :format, val, "int32")
    end
