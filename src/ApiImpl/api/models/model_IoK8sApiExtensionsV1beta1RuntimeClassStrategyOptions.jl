...
@doc raw"""io.k8s.api.extensions.v1beta1.RuntimeClassStrategyOptions
...
"""
Base.@kwdef mutable struct IoK8sApiExtensionsV1beta1RuntimeClassStrategyOptions <: OpenAPI.APIModel
    allowedRuntimeClassNames::Union{Nothing, Vector{String}} = nothing
    defaultRuntimeClassName::Union{Nothing, String} = nothing

    function IoK8sApiExtensionsV1beta1RuntimeClassStrategyOptions(allowedRuntimeClassNames, defaultRuntimeClassName, )
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1RuntimeClassStrategyOptions, Symbol("allowedRuntimeClassNames"), allowedRuntimeClassNames)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1RuntimeClassStrategyOptions, Symbol("defaultRuntimeClassName"), defaultRuntimeClassName)
...
OpenAPI.property_type(::Type{ IoK8sApiExtensionsV1beta1RuntimeClassStrategyOptions }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1RuntimeClassStrategyOptions[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiExtensionsV1beta1RuntimeClassStrategyOptions }, name::Symbol, val)
end
