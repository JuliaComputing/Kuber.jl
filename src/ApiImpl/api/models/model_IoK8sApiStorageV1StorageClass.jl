...
@doc raw"""io.k8s.api.storage.v1.StorageClass
...
"""
Base.@kwdef mutable struct IoK8sApiStorageV1StorageClass <: OpenAPI.APIModel
    ...
    function IoK8sApiStorageV1StorageClass(allowVolumeExpansion, allowedTopologies, apiVersion, kind, metadata, mountOptions, parameters, provisioner, reclaimPolicy, volumeBindingMode, )
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("allowVolumeExpansion"), allowVolumeExpansion)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("allowedTopologies"), allowedTopologies)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("apiVersion"), apiVersion)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("kind"), kind)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("metadata"), metadata)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("mountOptions"), mountOptions)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("parameters"), parameters)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("provisioner"), provisioner)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("reclaimPolicy"), reclaimPolicy)
        OpenAPI.validate_property(IoK8sApiStorageV1StorageClass, Symbol("volumeBindingMode"), volumeBindingMode)
...
OpenAPI.property_type(::Type{ IoK8sApiStorageV1StorageClass }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiStorageV1StorageClass[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiStorageV1StorageClass }, name::Symbol, val)
end
