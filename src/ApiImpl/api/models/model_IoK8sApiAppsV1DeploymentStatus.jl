...
@doc raw"""io.k8s.api.apps.v1.DeploymentStatus
DeploymentStatus is the most recently observed status of the Deployment.
    ...
    - conditions::Vector{IoK8sApiAppsV1DeploymentCondition} : Represents the latest available observations of a deployment&#39;s current state.
...
"""
Base.@kwdef mutable struct IoK8sApiAppsV1DeploymentStatus <: OpenAPI.APIModel
    availableReplicas::Union{Nothing, Int64} = nothing
    collisionCount::Union{Nothing, Int64} = nothing
    conditions::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{IoK8sApiAppsV1DeploymentCondition} }
    ...
    function IoK8sApiAppsV1DeploymentStatus(availableReplicas, collisionCount, conditions, observedGeneration, readyReplicas, replicas, unavailableReplicas, updatedReplicas, )
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("availableReplicas"), availableReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("collisionCount"), collisionCount)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("conditions"), conditions)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("observedGeneration"), observedGeneration)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("readyReplicas"), readyReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("replicas"), replicas)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("unavailableReplicas"), unavailableReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1DeploymentStatus, Symbol("updatedReplicas"), updatedReplicas)
...
const _property_types_IoK8sApiAppsV1DeploymentStatus = Dict{Symbol,String}(Symbol("availableReplicas")=>"Int64", Symbol("collisionCount")=>"Int64", Symbol("conditions")=>"Vector{IoK8sApiAppsV1DeploymentCondition}", Symbol("observedGeneration")=>"Int64", Symbol("readyReplicas")=>"Int64", Symbol("replicas")=>"Int64", Symbol("unavailableReplicas")=>"Int64", Symbol("updatedReplicas")=>"Int64", )
OpenAPI.property_type(::Type{ IoK8sApiAppsV1DeploymentStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1DeploymentStatus[name]))}

function check_required(o::IoK8sApiAppsV1DeploymentStatus)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiAppsV1DeploymentStatus }, name::Symbol, val)
    if name === Symbol("availableReplicas")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1DeploymentStatus", :format, val, "int32")
    end
    if name === Symbol("collisionCount")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1DeploymentStatus", :format, val, "int32")
    end
    if name === Symbol("observedGeneration")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1DeploymentStatus", :format, val, "int64")
    end
