...
@doc raw"""io.k8s.api.core.v1.ScaleIOPersistentVolumeSource
...
"""
Base.@kwdef mutable struct IoK8sApiCoreV1ScaleIOPersistentVolumeSource <: OpenAPI.APIModel
    ...
    function IoK8sApiCoreV1ScaleIOPersistentVolumeSource(fsType, gateway, protectionDomain, readOnly, secretRef, sslEnabled, storageMode, storagePool, system, volumeName, )
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("fsType"), fsType)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("gateway"), gateway)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("protectionDomain"), protectionDomain)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("readOnly"), readOnly)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("secretRef"), secretRef)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("sslEnabled"), sslEnabled)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("storageMode"), storageMode)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("storagePool"), storagePool)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("system"), system)
        OpenAPI.validate_property(IoK8sApiCoreV1ScaleIOPersistentVolumeSource, Symbol("volumeName"), volumeName)
...
OpenAPI.property_type(::Type{ IoK8sApiCoreV1ScaleIOPersistentVolumeSource }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiCoreV1ScaleIOPersistentVolumeSource[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiCoreV1ScaleIOPersistentVolumeSource }, name::Symbol, val)
end
