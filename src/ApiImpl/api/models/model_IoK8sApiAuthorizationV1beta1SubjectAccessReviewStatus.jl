...
@doc raw"""io.k8s.api.authorization.v1beta1.SubjectAccessReviewStatus
...
"""
Base.@kwdef mutable struct IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus <: OpenAPI.APIModel
    ...
    function IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus(allowed, denied, evaluationError, reason, )
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus, Symbol("allowed"), allowed)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus, Symbol("denied"), denied)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus, Symbol("evaluationError"), evaluationError)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus, Symbol("reason"), reason)
...
OpenAPI.property_type(::Type{ IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus }, name::Symbol, val)
end
