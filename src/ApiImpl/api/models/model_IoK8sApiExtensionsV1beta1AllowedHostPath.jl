...
@doc raw"""io.k8s.api.extensions.v1beta1.AllowedHostPath
...
"""
Base.@kwdef mutable struct IoK8sApiExtensionsV1beta1AllowedHostPath <: OpenAPI.APIModel
    pathPrefix::Union{Nothing, String} = nothing
    readOnly::Union{Nothing, Bool} = nothing

    function IoK8sApiExtensionsV1beta1AllowedHostPath(pathPrefix, readOnly, )
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1AllowedHostPath, Symbol("pathPrefix"), pathPrefix)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1AllowedHostPath, Symbol("readOnly"), readOnly)
...
OpenAPI.property_type(::Type{ IoK8sApiExtensionsV1beta1AllowedHostPath }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1AllowedHostPath[name]))}

function check_required(o::IoK8sApiExtensionsV1beta1AllowedHostPath)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiExtensionsV1beta1AllowedHostPath }, name::Symbol, val)
end
