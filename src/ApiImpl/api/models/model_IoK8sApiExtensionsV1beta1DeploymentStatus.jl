...
@doc raw"""io.k8s.api.extensions.v1beta1.DeploymentStatus
DeploymentStatus is the most recently observed status of the Deployment.
    ...
    - conditions::Vector{IoK8sApiExtensionsV1beta1DeploymentCondition} : Represents the latest available observations of a deployment&#39;s current state.
...
"""
Base.@kwdef mutable struct IoK8sApiExtensionsV1beta1DeploymentStatus <: OpenAPI.APIModel
    availableReplicas::Union{Nothing, Int64} = nothing
    collisionCount::Union{Nothing, Int64} = nothing
    conditions::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{IoK8sApiExtensionsV1beta1DeploymentCondition} }
    ...
    function IoK8sApiExtensionsV1beta1DeploymentStatus(availableReplicas, collisionCount, conditions, observedGeneration, readyReplicas, replicas, unavailableReplicas, updatedReplicas, )
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("availableReplicas"), availableReplicas)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("collisionCount"), collisionCount)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("conditions"), conditions)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("observedGeneration"), observedGeneration)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("readyReplicas"), readyReplicas)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("replicas"), replicas)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("unavailableReplicas"), unavailableReplicas)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1DeploymentStatus, Symbol("updatedReplicas"), updatedReplicas)
...
end # type IoK8sApiExtensionsV1beta1DeploymentStatus
...
OpenAPI.property_type(::Type{ IoK8sApiExtensionsV1beta1DeploymentStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1DeploymentStatus[name]))}

function check_required(o::IoK8sApiExtensionsV1beta1DeploymentStatus)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiExtensionsV1beta1DeploymentStatus }, name::Symbol, val)
    if name === Symbol("availableReplicas")
        OpenAPI.validate_param(name, "IoK8sApiExtensionsV1beta1DeploymentStatus", :format, val, "int32")
    end
    if name === Symbol("collisionCount")
        OpenAPI.validate_param(name, "IoK8sApiExtensionsV1beta1DeploymentStatus", :format, val, "int32")
    end
    if name === Symbol("observedGeneration")
        OpenAPI.validate_param(name, "IoK8sApiExtensionsV1beta1DeploymentStatus", :format, val, "int64")
    end
