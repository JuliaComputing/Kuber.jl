...
@doc raw"""io.k8s.api.core.v1.RBDPersistentVolumeSource
...
"""
Base.@kwdef mutable struct IoK8sApiCoreV1RBDPersistentVolumeSource <: OpenAPI.APIModel
    ...
    function IoK8sApiCoreV1RBDPersistentVolumeSource(fsType, image, keyring, monitors, pool, readOnly, secretRef, user, )
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("fsType"), fsType)
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("image"), image)
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("keyring"), keyring)
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("monitors"), monitors)
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("pool"), pool)
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("readOnly"), readOnly)
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("secretRef"), secretRef)
        OpenAPI.validate_property(IoK8sApiCoreV1RBDPersistentVolumeSource, Symbol("user"), user)
...
OpenAPI.property_type(::Type{ IoK8sApiCoreV1RBDPersistentVolumeSource }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiCoreV1RBDPersistentVolumeSource[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiCoreV1RBDPersistentVolumeSource }, name::Symbol, val)
end
