...
@doc raw"""io.k8s.api.apps.v1.StatefulSetStatus
...
"""
Base.@kwdef mutable struct IoK8sApiAppsV1StatefulSetStatus <: OpenAPI.APIModel
    collisionCount::Union{Nothing, Int64} = nothing
    conditions::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{IoK8sApiAppsV1StatefulSetCondition} }
    ...
    function IoK8sApiAppsV1StatefulSetStatus(collisionCount, conditions, currentReplicas, currentRevision, observedGeneration, readyReplicas, replicas, updateRevision, updatedReplicas, )
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("collisionCount"), collisionCount)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("conditions"), conditions)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("currentReplicas"), currentReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("currentRevision"), currentRevision)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("observedGeneration"), observedGeneration)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("readyReplicas"), readyReplicas)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("replicas"), replicas)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("updateRevision"), updateRevision)
        OpenAPI.validate_property(IoK8sApiAppsV1StatefulSetStatus, Symbol("updatedReplicas"), updatedReplicas)
...
const _property_types_IoK8sApiAppsV1StatefulSetStatus = Dict{Symbol,String}(Symbol("collisionCount")=>"Int64", Symbol("conditions")=>"Vector{IoK8sApiAppsV1StatefulSetCondition}", Symbol("currentReplicas")=>"Int64", Symbol("currentRevision")=>"String", Symbol("observedGeneration")=>"Int64", Symbol("readyReplicas")=>"Int64", Symbol("replicas")=>"Int64", Symbol("updateRevision")=>"String", Symbol("updatedReplicas")=>"Int64", )
OpenAPI.property_type(::Type{ IoK8sApiAppsV1StatefulSetStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1StatefulSetStatus[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiAppsV1StatefulSetStatus }, name::Symbol, val)
    if name === Symbol("collisionCount")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1StatefulSetStatus", :format, val, "int32")
    end
    if name === Symbol("currentReplicas")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1StatefulSetStatus", :format, val, "int32")
    end
    if name === Symbol("observedGeneration")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1StatefulSetStatus", :format, val, "int64")
    end
