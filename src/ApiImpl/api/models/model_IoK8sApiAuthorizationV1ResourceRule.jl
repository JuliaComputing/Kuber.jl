...
@doc raw"""io.k8s.api.authorization.v1.ResourceRule
...
"""
Base.@kwdef mutable struct IoK8sApiAuthorizationV1ResourceRule <: OpenAPI.APIModel
    ...
    function IoK8sApiAuthorizationV1ResourceRule(apiGroups, resourceNames, resources, verbs, )
        OpenAPI.validate_property(IoK8sApiAuthorizationV1ResourceRule, Symbol("apiGroups"), apiGroups)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1ResourceRule, Symbol("resourceNames"), resourceNames)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1ResourceRule, Symbol("resources"), resources)
        OpenAPI.validate_property(IoK8sApiAuthorizationV1ResourceRule, Symbol("verbs"), verbs)
...
OpenAPI.property_type(::Type{ IoK8sApiAuthorizationV1ResourceRule }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAuthorizationV1ResourceRule[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiAuthorizationV1ResourceRule }, name::Symbol, val)
end
