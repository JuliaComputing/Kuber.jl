...
@doc raw"""io.k8s.api.apps.v1.DaemonSetStatus
...
"""
Base.@kwdef mutable struct IoK8sApiAppsV1DaemonSetStatus <: OpenAPI.APIModel
    collisionCount::Union{Nothing, Int64} = nothing
    conditions::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{IoK8sApiAppsV1DaemonSetCondition} }
    ...
    function IoK8sApiAppsV1DaemonSetStatus(collisionCount, conditions, currentNumberScheduled, desiredNumberScheduled, numberAvailable, numberMisscheduled, numberReady, numberUnavailable, observedGeneration, updatedNumberScheduled, )
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("collisionCount"), collisionCount)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("conditions"), conditions)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("currentNumberScheduled"), currentNumberScheduled)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("desiredNumberScheduled"), desiredNumberScheduled)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("numberAvailable"), numberAvailable)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("numberMisscheduled"), numberMisscheduled)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("numberReady"), numberReady)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("numberUnavailable"), numberUnavailable)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("observedGeneration"), observedGeneration)
        OpenAPI.validate_property(IoK8sApiAppsV1DaemonSetStatus, Symbol("updatedNumberScheduled"), updatedNumberScheduled)
...
const _property_types_IoK8sApiAppsV1DaemonSetStatus = Dict{Symbol,String}(Symbol("collisionCount")=>"Int64", Symbol("conditions")=>"Vector{IoK8sApiAppsV1DaemonSetCondition}", Symbol("currentNumberScheduled")=>"Int64", Symbol("desiredNumberScheduled")=>"Int64", Symbol("numberAvailable")=>"Int64", Symbol("numberMisscheduled")=>"Int64", Symbol("numberReady")=>"Int64", Symbol("numberUnavailable")=>"Int64", Symbol("observedGeneration")=>"Int64", Symbol("updatedNumberScheduled")=>"Int64", )
OpenAPI.property_type(::Type{ IoK8sApiAppsV1DaemonSetStatus }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAppsV1DaemonSetStatus[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiAppsV1DaemonSetStatus }, name::Symbol, val)
    if name === Symbol("collisionCount")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1DaemonSetStatus", :format, val, "int32")
    end
    ...
    if name === Symbol("observedGeneration")
        OpenAPI.validate_param(name, "IoK8sApiAppsV1DaemonSetStatus", :format, val, "int64")
    end
