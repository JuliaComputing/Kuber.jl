...
@doc raw"""io.k8s.api.networking.v1beta1.IngressTLS
...
"""
Base.@kwdef mutable struct IoK8sApiNetworkingV1beta1IngressTLS <: OpenAPI.APIModel
    hosts::Union{Nothing, Vector{String}} = nothing
    secretName::Union{Nothing, String} = nothing

    function IoK8sApiNetworkingV1beta1IngressTLS(hosts, secretName, )
        OpenAPI.validate_property(IoK8sApiNetworkingV1beta1IngressTLS, Symbol("hosts"), hosts)
        OpenAPI.validate_property(IoK8sApiNetworkingV1beta1IngressTLS, Symbol("secretName"), secretName)
...
OpenAPI.property_type(::Type{ IoK8sApiNetworkingV1beta1IngressTLS }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiNetworkingV1beta1IngressTLS[name]))}

function check_required(o::IoK8sApiNetworkingV1beta1IngressTLS)
    true
end

function OpenAPI.validate_property(::Type{ IoK8sApiNetworkingV1beta1IngressTLS }, name::Symbol, val)
end
