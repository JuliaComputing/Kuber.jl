...
@doc raw"""io.k8s.api.extensions.v1beta1.RunAsGroupStrategyOptions
...
"""
Base.@kwdef mutable struct IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions <: OpenAPI.APIModel
    ...
    function IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions(ranges, rule, )
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions, Symbol("ranges"), ranges)
        OpenAPI.validate_property(IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions, Symbol("rule"), rule)
...
OpenAPI.property_type(::Type{ IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions }, name::Symbol, val)
end
