...
const _property_types_IoK8sApiPolicyV1beta1PodDisruptionBudgetSpec = Dict{Symbol,String}(Symbol("maxUnavailable")=>"String", Symbol("minAvailable")=>"String", Symbol("selector")=>"IoK8sApimachineryPkgApisMetaV1LabelSelector", )
