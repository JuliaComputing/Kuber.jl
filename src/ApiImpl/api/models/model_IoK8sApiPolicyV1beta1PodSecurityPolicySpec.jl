...
@doc raw"""io.k8s.api.policy.v1beta1.PodSecurityPolicySpec
...
"""
Base.@kwdef mutable struct IoK8sApiPolicyV1beta1PodSecurityPolicySpec <: OpenAPI.APIModel
    allowPrivilegeEscalation::Union{Nothing, Bool} = nothing
    allowedCSIDrivers::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{IoK8sApiPolicyV1beta1AllowedCSIDriver} }
    ...
    fsGroup = nothing # spec type: Union{ Nothing, IoK8sApiPolicyV1beta1FSGroupStrategyOptions }
    hostIPC::Union{Nothing, Bool} = nothing
    hostNetwork::Union{Nothing, Bool} = nothing
    hostPID::Union{Nothing, Bool} = nothing
    hostPorts::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{IoK8sApiPolicyV1beta1HostPortRange} }
    ...
    supplementalGroups = nothing # spec type: Union{ Nothing, IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions }
    ...
    function IoK8sApiPolicyV1beta1PodSecurityPolicySpec(allowPrivilegeEscalation, allowedCSIDrivers, allowedCapabilities, allowedFlexVolumes, allowedHostPaths, allowedProcMountTypes, allowedUnsafeSysctls, defaultAddCapabilities, defaultAllowPrivilegeEscalation, forbiddenSysctls, fsGroup, hostIPC, hostNetwork, hostPID, hostPorts, privileged, readOnlyRootFilesystem, requiredDropCapabilities, runAsGroup, runAsUser, runtimeClass, seLinux, supplementalGroups, volumes, )
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("allowPrivilegeEscalation"), allowPrivilegeEscalation)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("allowedCSIDrivers"), allowedCSIDrivers)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("allowedCapabilities"), allowedCapabilities)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("allowedFlexVolumes"), allowedFlexVolumes)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("allowedHostPaths"), allowedHostPaths)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("allowedProcMountTypes"), allowedProcMountTypes)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("allowedUnsafeSysctls"), allowedUnsafeSysctls)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("defaultAddCapabilities"), defaultAddCapabilities)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("defaultAllowPrivilegeEscalation"), defaultAllowPrivilegeEscalation)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("forbiddenSysctls"), forbiddenSysctls)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("fsGroup"), fsGroup)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("hostIPC"), hostIPC)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("hostNetwork"), hostNetwork)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("hostPID"), hostPID)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("hostPorts"), hostPorts)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("privileged"), privileged)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("readOnlyRootFilesystem"), readOnlyRootFilesystem)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("requiredDropCapabilities"), requiredDropCapabilities)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("runAsGroup"), runAsGroup)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("runAsUser"), runAsUser)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("runtimeClass"), runtimeClass)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("seLinux"), seLinux)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("supplementalGroups"), supplementalGroups)
        OpenAPI.validate_property(IoK8sApiPolicyV1beta1PodSecurityPolicySpec, Symbol("volumes"), volumes)
...
OpenAPI.property_type(::Type{ IoK8sApiPolicyV1beta1PodSecurityPolicySpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiPolicyV1beta1PodSecurityPolicySpec[name]))}
...
function OpenAPI.validate_property(::Type{ IoK8sApiPolicyV1beta1PodSecurityPolicySpec }, name::Symbol, val)
end
