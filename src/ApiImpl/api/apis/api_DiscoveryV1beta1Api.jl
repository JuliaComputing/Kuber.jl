...
struct DiscoveryV1beta1Api <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `DiscoveryV1beta1Api`.
...
@doc raw"""create an EndpointSlice

Params:
- namespace::String (required)
- body::IoK8sApiDiscoveryV1beta1EndpointSlice (required)
- pretty::String
- dry_run::String
- field_manager::String

Return: IoK8sApiDiscoveryV1beta1EndpointSlice, OpenAPI.Clients.ApiResponse
"""
function create_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, namespace::String, body::IoK8sApiDiscoveryV1beta1EndpointSlice; pretty=nothing, dry_run=nothing, field_manager=nothing, _mediaType=nothing)
    _ctx = _oacinternal_create_discovery_v1beta1_namespaced_endpoint_slice(_api, namespace, body; pretty=pretty, dry_run=dry_run, field_manager=field_manager, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function create_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, response_stream::Channel, namespace::String, body::IoK8sApiDiscoveryV1beta1EndpointSlice; pretty=nothing, dry_run=nothing, field_manager=nothing, _mediaType=nothing)
    _ctx = _oacinternal_create_discovery_v1beta1_namespaced_endpoint_slice(_api, namespace, body; pretty=pretty, dry_run=dry_run, field_manager=field_manager, _mediaType=_mediaType)
...
@doc raw"""delete collection of EndpointSlice
...
@doc raw"""delete an EndpointSlice
...
Return: IoK8sApimachineryPkgApisMetaV1Status, OpenAPI.Clients.ApiResponse
"""
function delete_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, name::String, namespace::String; pretty=nothing, dry_run=nothing, grace_period_seconds=nothing, orphan_dependents=nothing, propagation_policy=nothing, body=nothing, _mediaType=nothing)
    _ctx = _oacinternal_delete_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace; pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, response_stream::Channel, name::String, namespace::String; pretty=nothing, dry_run=nothing, grace_period_seconds=nothing, orphan_dependents=nothing, propagation_policy=nothing, body=nothing, _mediaType=nothing)
    _ctx = _oacinternal_delete_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace; pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
"""
function get_discovery_v1beta1_a_p_i_resources(_api::DiscoveryV1beta1Api; _mediaType=nothing)
    _ctx = _oacinternal_get_discovery_v1beta1_a_p_i_resources(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_discovery_v1beta1_a_p_i_resources(_api::DiscoveryV1beta1Api, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_discovery_v1beta1_a_p_i_resources(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
@doc raw"""list or watch objects of kind EndpointSlice
...
Return: IoK8sApiDiscoveryV1beta1EndpointSliceList, OpenAPI.Clients.ApiResponse
"""
function list_discovery_v1beta1_endpoint_slice_for_all_namespaces(_api::DiscoveryV1beta1Api; allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, pretty=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_discovery_v1beta1_endpoint_slice_for_all_namespaces(_api; allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function list_discovery_v1beta1_endpoint_slice_for_all_namespaces(_api::DiscoveryV1beta1Api, response_stream::Channel; allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, pretty=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_discovery_v1beta1_endpoint_slice_for_all_namespaces(_api; allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
Return: IoK8sApiDiscoveryV1beta1EndpointSliceList, OpenAPI.Clients.ApiResponse
"""
function list_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, namespace::String; pretty=nothing, allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_discovery_v1beta1_namespaced_endpoint_slice(_api, namespace; pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function list_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, response_stream::Channel, namespace::String; pretty=nothing, allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_discovery_v1beta1_namespaced_endpoint_slice(_api, namespace; pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
@doc raw"""partially update the specified EndpointSlice
...
Return: IoK8sApiDiscoveryV1beta1EndpointSlice, OpenAPI.Clients.ApiResponse
"""
function patch_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, name::String, namespace::String, body::Any; pretty=nothing, dry_run=nothing, field_manager=nothing, force=nothing, _mediaType=nothing)
    _ctx = _oacinternal_patch_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace, body; pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function patch_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, response_stream::Channel, name::String, namespace::String, body::Any; pretty=nothing, dry_run=nothing, field_manager=nothing, force=nothing, _mediaType=nothing)
    _ctx = _oacinternal_patch_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace, body; pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
@doc raw"""read the specified EndpointSlice
...
Return: IoK8sApiDiscoveryV1beta1EndpointSlice, OpenAPI.Clients.ApiResponse
"""
function read_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, name::String, namespace::String; pretty=nothing, exact=nothing, __export__=nothing, _mediaType=nothing)
    _ctx = _oacinternal_read_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace; pretty=pretty, exact=exact, __export__=__export__, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function read_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, response_stream::Channel, name::String, namespace::String; pretty=nothing, exact=nothing, __export__=nothing, _mediaType=nothing)
    _ctx = _oacinternal_read_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace; pretty=pretty, exact=exact, __export__=__export__, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
@doc raw"""replace the specified EndpointSlice
...
Return: IoK8sApiDiscoveryV1beta1EndpointSlice, OpenAPI.Clients.ApiResponse
"""
function replace_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, name::String, namespace::String, body::IoK8sApiDiscoveryV1beta1EndpointSlice; pretty=nothing, dry_run=nothing, field_manager=nothing, _mediaType=nothing)
    _ctx = _oacinternal_replace_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace, body; pretty=pretty, dry_run=dry_run, field_manager=field_manager, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function replace_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, response_stream::Channel, name::String, namespace::String, body::IoK8sApiDiscoveryV1beta1EndpointSlice; pretty=nothing, dry_run=nothing, field_manager=nothing, _mediaType=nothing)
    _ctx = _oacinternal_replace_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace, body; pretty=pretty, dry_run=dry_run, field_manager=field_manager, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
@doc raw"""watch individual changes to a list of EndpointSlice. deprecated: use the 'watch' parameter with a list operation instead.
...
"""
function watch_discovery_v1beta1_endpoint_slice_list_for_all_namespaces(_api::DiscoveryV1beta1Api; allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, pretty=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_watch_discovery_v1beta1_endpoint_slice_list_for_all_namespaces(_api; allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end
...
@doc raw"""watch changes to an object of kind EndpointSlice. deprecated: use the 'watch' parameter with a list operation instead, filtered to a single item with the 'fieldSelector' parameter.
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent, OpenAPI.Clients.ApiResponse
"""
function watch_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, name::String, namespace::String; allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, pretty=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_watch_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace; allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function watch_discovery_v1beta1_namespaced_endpoint_slice(_api::DiscoveryV1beta1Api, response_stream::Channel, name::String, namespace::String; allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, pretty=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_watch_discovery_v1beta1_namespaced_endpoint_slice(_api, name, namespace; allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
Return: IoK8sApimachineryPkgApisMetaV1WatchEvent, OpenAPI.Clients.ApiResponse
"""
function watch_discovery_v1beta1_namespaced_endpoint_slice_list(_api::DiscoveryV1beta1Api, namespace::String; allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, pretty=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_watch_discovery_v1beta1_namespaced_endpoint_slice_list(_api, namespace; allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function watch_discovery_v1beta1_namespaced_endpoint_slice_list(_api::DiscoveryV1beta1Api, response_stream::Channel, namespace::String; allow_watch_bookmarks=nothing, __continue__=nothing, field_selector=nothing, label_selector=nothing, limit=nothing, pretty=nothing, resource_version=nothing, timeout_seconds=nothing, watch=nothing, _mediaType=nothing)
    _ctx = _oacinternal_watch_discovery_v1beta1_namespaced_endpoint_slice_list(_api, namespace; allow_watch_bookmarks=allow_watch_bookmarks, __continue__=__continue__, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export create_discovery_v1beta1_namespaced_endpoint_slice
export delete_discovery_v1beta1_collection_namespaced_endpoint_slice
export delete_discovery_v1beta1_namespaced_endpoint_slice
export get_discovery_v1beta1_a_p_i_resources
export list_discovery_v1beta1_endpoint_slice_for_all_namespaces
export list_discovery_v1beta1_namespaced_endpoint_slice
export patch_discovery_v1beta1_namespaced_endpoint_slice
export read_discovery_v1beta1_namespaced_endpoint_slice
export replace_discovery_v1beta1_namespaced_endpoint_slice
export watch_discovery_v1beta1_endpoint_slice_list_for_all_namespaces
export watch_discovery_v1beta1_namespaced_endpoint_slice
export watch_discovery_v1beta1_namespaced_endpoint_slice_list
