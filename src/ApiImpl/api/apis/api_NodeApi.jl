...
const _returntypes_get_node_a_p_i_group = Dict{Regex,Type}(
...
function _oacinternal_get_node_a_p_i_group(_api::NodeApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_node_a_p_i_group, "/apis/node.k8s.io/", ["BearerToken", ])
