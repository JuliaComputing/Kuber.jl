...
const _returntypes_get_apiextensions_a_p_i_group = Dict{Regex,Type}(
...
function _oacinternal_get_apiextensions_a_p_i_group(_api::ApiextensionsApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_apiextensions_a_p_i_group, "/apis/apiextensions.k8s.io/", ["BearerToken", ])
