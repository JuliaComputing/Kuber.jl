...
const _returntypes_get_authorization_a_p_i_group_AuthorizationApi = Dict{Regex,Type}(
...
function _oacinternal_get_authorization_a_p_i_group(_api::AuthorizationApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_authorization_a_p_i_group_AuthorizationApi, "/apis/authorization.k8s.io/", ["BearerToken", ])
