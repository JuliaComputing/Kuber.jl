...
struct SettingsApi <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `SettingsApi`.
...
"""
function get_settings_a_p_i_group(_api::SettingsApi; _mediaType=nothing)
    _ctx = _oacinternal_get_settings_a_p_i_group(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_settings_a_p_i_group(_api::SettingsApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_settings_a_p_i_group(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export get_settings_a_p_i_group
