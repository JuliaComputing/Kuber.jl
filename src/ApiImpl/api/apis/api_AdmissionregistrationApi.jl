...
const _returntypes_get_admissionregistration_a_p_i_group = Dict{Regex,Type}(
...
function _oacinternal_get_admissionregistration_a_p_i_group(_api::AdmissionregistrationApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_admissionregistration_a_p_i_group, "/apis/admissionregistration.k8s.io/", ["BearerToken", ])
