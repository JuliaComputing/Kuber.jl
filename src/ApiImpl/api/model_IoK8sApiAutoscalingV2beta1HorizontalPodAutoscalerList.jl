...
@doc raw"""HorizontalPodAutoscaler is a list of horizontal pod autoscaler objects.
...
Swagger.property_type(::Type{ IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList[name]))}
