...
mutable struct IoK8sApiRbacV1PolicyRule <: SwaggerModel
    ...
    function IoK8sApiRbacV1PolicyRule(;apiGroups=nothing, nonResourceURLs=nothing, resourceNames=nothing, resources=nothing, verbs=nothing)
        o = new()
        validate_property(IoK8sApiRbacV1PolicyRule, Symbol("apiGroups"), apiGroups)
        setfield!(o, Symbol("apiGroups"), apiGroups)
        validate_property(IoK8sApiRbacV1PolicyRule, Symbol("nonResourceURLs"), nonResourceURLs)
        setfield!(o, Symbol("nonResourceURLs"), nonResourceURLs)
        validate_property(IoK8sApiRbacV1PolicyRule, Symbol("resourceNames"), resourceNames)
        setfield!(o, Symbol("resourceNames"), resourceNames)
        validate_property(IoK8sApiRbacV1PolicyRule, Symbol("resources"), resources)
        setfield!(o, Symbol("resources"), resources)
        validate_property(IoK8sApiRbacV1PolicyRule, Symbol("verbs"), verbs)
        setfield!(o, Symbol("verbs"), verbs)
        o
    end
end # type IoK8sApiRbacV1PolicyRule

const _property_map_IoK8sApiRbacV1PolicyRule = Dict{Symbol,Symbol}(Symbol("apiGroups")=>Symbol("apiGroups"), Symbol("nonResourceURLs")=>Symbol("nonResourceURLs"), Symbol("resourceNames")=>Symbol("resourceNames"), Symbol("resources")=>Symbol("resources"), Symbol("verbs")=>Symbol("verbs"))
...
Base.propertynames(::Type{ IoK8sApiRbacV1PolicyRule }) = collect(keys(_property_map_IoK8sApiRbacV1PolicyRule))
Swagger.property_type(::Type{ IoK8sApiRbacV1PolicyRule }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiRbacV1PolicyRule[name]))}
Swagger.field_name(::Type{ IoK8sApiRbacV1PolicyRule }, property_name::Symbol) =  _property_map_IoK8sApiRbacV1PolicyRule[property_name]
...
function validate_property(::Type{ IoK8sApiRbacV1PolicyRule }, name::Symbol, val)
end
