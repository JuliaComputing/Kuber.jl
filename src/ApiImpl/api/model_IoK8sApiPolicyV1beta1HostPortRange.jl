...
mutable struct IoK8sApiPolicyV1beta1HostPortRange <: SwaggerModel
    ...
    function IoK8sApiPolicyV1beta1HostPortRange(;max=nothing, min=nothing)
        o = new()
        validate_property(IoK8sApiPolicyV1beta1HostPortRange, Symbol("max"), max)
        setfield!(o, Symbol("max"), max)
        validate_property(IoK8sApiPolicyV1beta1HostPortRange, Symbol("min"), min)
...
function validate_property(::Type{ IoK8sApiPolicyV1beta1HostPortRange }, name::Symbol, val)
end
