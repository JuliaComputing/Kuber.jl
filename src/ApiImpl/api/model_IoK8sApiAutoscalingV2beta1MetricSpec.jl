...
Swagger.property_type(::Type{ IoK8sApiAutoscalingV2beta1MetricSpec }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_IoK8sApiAutoscalingV2beta1MetricSpec[name]))}
