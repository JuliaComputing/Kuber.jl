...
function set_field!(o::V1ObjectMeta, name::Symbol, val)
    setfield!(o, name, fieldtype(V1ObjectMeta,name)(val))
end

convert(::Type{ V1ObjectMeta }, json::Dict{String,Any}) = Swagger.from_json(V1ObjectMeta, json)
