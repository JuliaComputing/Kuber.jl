...
function set_field!(o::UnversionedStatus, name::Symbol, val)
    setfield!(o, name, fieldtype(UnversionedStatus,name)(val))
end

convert(::Type{ UnversionedStatus }, json::Dict{String,Any}) = Swagger.from_json(UnversionedStatus, json)
