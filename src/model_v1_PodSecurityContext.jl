...
function set_field!(o::V1PodSecurityContext, name::Symbol, val)
    setfield!(o, name, fieldtype(V1PodSecurityContext,name)(val))
end

convert(::Type{ V1PodSecurityContext }, json::Dict{String,Any}) = Swagger.from_json(V1PodSecurityContext, json)
