...
function set_field!(o::V1LocalObjectReference, name::Symbol, val)
    setfield!(o, name, fieldtype(V1LocalObjectReference,name)(val))
end

convert(::Type{ V1LocalObjectReference }, json::Dict{String,Any}) = Swagger.from_json(V1LocalObjectReference, json)
