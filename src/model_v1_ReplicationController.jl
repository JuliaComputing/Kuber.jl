...
function set_field!(o::V1ReplicationController, name::Symbol, val)
    setfield!(o, name, fieldtype(V1ReplicationController,name)(val))
end

convert(::Type{ V1ReplicationController }, json::Dict{String,Any}) = Swagger.from_json(V1ReplicationController, json)
