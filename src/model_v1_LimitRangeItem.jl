...
function set_field!(o::V1LimitRangeItem, name::Symbol, val)
    setfield!(o, name, fieldtype(V1LimitRangeItem,name)(val))
end

convert(::Type{ V1LimitRangeItem }, json::Dict{String,Any}) = Swagger.from_json(V1LimitRangeItem, json)
