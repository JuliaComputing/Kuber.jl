...
function set_field!(o::V1ContainerPort, name::Symbol, val)
    setfield!(o, name, fieldtype(V1ContainerPort,name)(val))
end

convert(::Type{ V1ContainerPort }, json::Dict{String,Any}) = Swagger.from_json(V1ContainerPort, json)
