...
function set_field!(o::V1beta1JobCondition, name::Symbol, val)
    setfield!(o, name, fieldtype(V1beta1JobCondition,name)(val))
end

convert(::Type{ V1beta1JobCondition }, json::Dict{String,Any}) = Swagger.from_json(V1beta1JobCondition, json)
