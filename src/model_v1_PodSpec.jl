...
function set_field!(o::V1PodSpec, name::Symbol, val)
    setfield!(o, name, fieldtype(V1PodSpec,name)(val))
end

convert(::Type{ V1PodSpec }, json::Dict{String,Any}) = Swagger.from_json(V1PodSpec, json)
