...
function set_field!(o::V1HTTPGetAction, name::Symbol, val)
    setfield!(o, name, fieldtype(V1HTTPGetAction,name)(val))
end

convert(::Type{ V1HTTPGetAction }, json::Dict{String,Any}) = Swagger.from_json(V1HTTPGetAction, json)
