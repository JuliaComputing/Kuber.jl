...
type V1alpha1CertificateSigningRequestCondition
...
function set_field!(o::V1alpha1CertificateSigningRequestCondition, name::Symbol, val)
    setfield!(o, name, fieldtype(V1alpha1CertificateSigningRequestCondition,name)(val))
end

convert(::Type{ V1alpha1CertificateSigningRequestCondition }, json::Dict{String,Any}) = Swagger.from_json(V1alpha1CertificateSigningRequestCondition, json)
